...
/*=================================================
   charset=utf-8
   Project:	phpGedView
   File:	configure_help.ru.php
   Author:	John Finlay
   Translator: Natalia Anikeeva
   Comments:	Russian Language Configure Help file for PhpGedView
   Change Log:	2004/02/01 - File Created
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: configure_help.zh.php,v 1.4 2004/01/08 15:15:31 yalnifj Exp $
