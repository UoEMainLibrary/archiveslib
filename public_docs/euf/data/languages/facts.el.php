...
/*=================================================
   ...
   Project:		phpGedView
   File:		facts.el.php
   Author:		Nicholas G. Antimisiaris-t
   Comments:	Defines an array of GEDCOM codes and the greek name facts that they represent.
   Change Log:	07/11/04 - File Created
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/facts.el.extra.php")) require $PGV_BASE_DIRECTORY . "languages/facts.el.extra.php";
