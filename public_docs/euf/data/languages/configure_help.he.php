...
/*=================================================
	charset=utf-8   
	Project:	phpGedView
	File:		configure_help.he.php
	Author:		John Finlay
	Developer:	KosherJava
	Translator:	Meliza
	Comments:	Hebrew Language Configure Help file for PhpGedView
...
===================================================*/
# $Id: configure_help.he.php,v 1.45.2.18 2005/04/22 18:16:49 meliza Exp $
if (preg_match("/configure_help\...\.php$/", $_SERVER["PHP_SELF"])>0) {
	print "אין לך גישה לספרית קבצי השפות.";
	exit;
}
...
$pgv_lang["THUMBNAIL_WIDTH"]		= "רוחב התמונות המזעריות שיווצרו";
...
$pgv_lang["SPLIT_PLACES_help"]		= "~#pgv_lang[SPLIT_PLACES]#~<br /><br />Set this to <b>Yes</b> to split each place name by commas into subfields for easier editing.  Example :<br /><ol><li>Default mode<br /><u>Place</u>: Half Moon Bay, San Mateo, California, USA<br /><br /><li>Split mode<br /><u>Country</u>: USA<br /><u>State</u>: California<br/><u>County</u>: San Mateo<br/><u>City</u>: Half Moon Bay</ol>";
...
$pgv_lang["meta_conf"]			= "מאפייני תצורה של תווי META";
$pgv_lang["configure_head"]			= "PhpGedView-תצורת ה";
$pgv_lang["gedconf_head"]			= "תצורת GEDCOM";
$pgv_lang["default_user"]			= "בנה מנהלן ברירת מחדל.";
$pgv_lang["about_user"]			= "עלך ליצור קודם כל משתמש מנהלתי ראשי. למשתמש זה יהיו זכויות לעדכן קבצי תצורה, לראות נתונים אישיים וליצור משתמשים אחרים.";
...
$pgv_lang["USE_RTL_FUNCTIONS"]		= "השתמש בעיבוד נתונים של שפות הנכתבות מימין לשמאל";
...
$pgv_lang["GEDCOM_ID_PREFIX"]		= "קידומת קוד זיהוי אישי ב-GEDCOM";
$pgv_lang["GEDCOM_ID_PREFIX_help"]		= "~#pgv_lang[GEDCOM_ID_PREFIX]#~<br /><br />Add this prefix to unprefixed IDs entered by users in response to ID prompts on Pedigree, Descendancy, Relationship, and other charts.<br />";
...
$pgv_lang["ZOOM_BOXES"]			= "אפשר הגדלה/הקטנה של תיבות התרשימים";
...
$pgv_lang["INDEX_DIRECTORY_help"]	= "~#pgv_lang[INDEX_DIRECTORY]#~<br /><br />The path to a readable and writable directory where PhpGedView should store index files (include the trailing \"/\").<br /><br />This sets \$INDEX_DIRECTORY in <i>config.php</i>.<br />";
...
$pgv_lang["MEDIA_DIRECTORY_help"]	= "~#pgv_lang[MEDIA_DIRECTORY]#~<br /><br />The media path must be a relative path within the PhpGedView website, like ./media/ (include the trailing \"/\").<br />";
...
$pgv_lang["SHOW_HIGHLIGHT_IMAGES"]	= "הראה תמונות בהדגשה בתיבות אישיות";
...
$pgv_lang["COMMON_NAMES_THRESHOLD"]	= "הכמות המינימלית של מקרים כדי להכלל ב-\"שמות המשפחה השכיחים\"";
...
$pgv_lang["META_TITLE"]			= "הוסף לתג הכתרת";
...
$pgv_lang["return_editconfig"]			= "תוכל לחזור להגדרה זו מתי שתרצה ע\"י הצבעה של תוכנת הגלישה שלך על הקובץ <i>edit_config.php</i>, או ע\"י לחיצה על הקישור <b>תצורה</b> הנימצאת בדף <b>#pgv_lang[gedcom_adm_head]#</b>.<br />";
...
$pgv_lang["upload_to_index"]			= "העלה את הקובץ לספרית האינדקסים שלך: ";
$pgv_lang["import_sql"]			= "בתיקית האינדקס שלך יש קבצי SQL. מכיוון שיתכן שמקורם בכלי ההגירה של משתמשים, תוכל לייבא את הנתונים למאגר הנתונים שלך. האם לנסות לייבא את הקובץ למאגר המידע שלך עכשיו? כל הנתונים הקשורים למשתמשים (משתמשים, חדשות, מועדפים, מבנה האזורים וההודעות) יעלמו ממאגר המידע שלך.<br /><br />אם תחליט להמשיך לייבא את הנתונים, PhpGedView ינשא לייבא את הנתונים. אם דבר זה לא מצליח, תתבקש להגדיר את המשתמש האדמיניסטרטיבי הראשוני.<br /><br />";
...
$pgv_lang["add_new_pp_setting"]		= "הוסף הגדרת פרטיות אישית חדשה";
$pgv_lang["add_new_up_setting"]		= "הוסף הגדרת פרטיות משתמש חדשה";
$pgv_lang["add_new_gf_setting"]		= "הוסף הגדרת פרטיות ערכים כלליים חדשה";
$pgv_lang["add_new_pf_setting"]		= "הוסף הגדרת פרטיות ערכים אישיים חדשה";
...
$pgv_lang["privacy_indi_id"]			= "קוד זיהוי";
$pgv_lang["privacy_source_id"]		= "קוד מקור";
...
$pgv_lang["edit_exist_person_privacy_settings"]	= "ערוך הגדרת פרטיות אישית קיימת";
$pgv_lang["edit_exist_user_privacy_settings"]	= "ערוך הגדרת פרטיות משתמש קיימת";
$pgv_lang["edit_exist_global_facts_settings"]	= "ערוך הגדרת פרטיות ערכים כלליים קיימת";
$pgv_lang["edit_exist_person_facts_settings"]	= "ערוך הגדרת פרטיות ערכים אישיים קיימת";
...
$pgv_lang["person_privacy"]			= "ערכי פרטיות של אנשים";
...
$pgv_lang["person_facts"]			= "ערכי פרטיות של נתונים אישיים";
...
$pgv_lang["lang_debug"]		= "אופצית ניפוי בגים של טכסט עזרה";
...
$pgv_lang["lang_debug_help"]		= "~#pgv_lang[lang_debug]#~<br /><br />#pgv_lang[lang_debug_desc]#<br />";
$pgv_lang["lang_debug_use"]		= "השתמש באופצית ניפוי באגים של טכסט עזרה";
...
$pgv_lang["edit_lang_utility_desc"]	= "ניתן להשתמש בתוכנת עזר זו בעריכת תוכן של קובץ שפה ע\"י שימוש בקובץ האנגלי.<br /><br />התוכנה מראה את התוכן של קובץ השפה האנגלי המקורי (יש ארבעה קבצים כאלה) ובמקביל את התוכן של קובץ השפה הנבחרת שלך.<br />לחץ על ההודעה מתחת לגירסה האנגלית ואז יפתח חלון חדש, ובו תוכל לעדכן את הטכסט. ניתן לשמור את השינוי או לוותר עליו.";
...
$pgv_lang["export_lang_utility_desc"]	= "ניתן ליצור תעוד למינהלנים.<br /><br />כלי עזר זה ייצור גירסת HTML של קובץ העזרה של התצורה בשפה הנבחרת. תוכל להשתמש בדפדפן שלך כדי להסתכל על הקובץ הזה הנימצא במבנה להדפסה.";
...
$pgv_lang["compare_lang_utility_desc"]	= "כלי עזר זה משווה בין שני קבצי שפות ומספק רשימה של התוספות והחסרים ביניהם.<br /><br />קרא את הקובץ <a href=\"languages/LANG_CHANGELOG.txt\" target=\"_blank\">LANG_CHANGELOG.txt</a> לגבי השינויים בגירסה האנגלית. קבצי האנגלית ישמשו יחוס לשפות האחרות.";
...
$pgv_lang["config_lang_utility"]		= "הקונפיגורציה של השפות שנתמכות";
...
$pgv_lang["flagsfile"]		= "שם קובץ הדגל";
$pgv_lang["flagsfile_help"]		= "~#pgv_lang[flagsfile]#~<br /><br />השם והנתיב של קובץ ציורי הדגלים של שפה נבחרת.<br />";
...
$pgv_lang["um_imp_users"] 		= "מיבא משתמשים";
$pgv_lang["um_imp_blocks"] 		= "מיבא אזורים";
$pgv_lang["um_imp_favorites"] 		= "מיבא מועדפים";
$pgv_lang["um_imp_messages"] 	= "מיבא הודעות";
$pgv_lang["um_imp_news"] 		= "מיבא חדשות";
$pgv_lang["um_nousers"] 		= "קובץ <i>authenticate.php</i> לא נמצא בתיקית ה-index שלך. ההגירה מבוטלת.";
...
$pgv_lang["um_bu_explain"] 		= "כלי זה יכול ליצור גיבוי לסוגי נתונים שונים של PhpGedView.<br /><br />הנתונים שתחליט לגבות יאספו בקובץ ZIP, שאותו תוכל להוריד על ידי לחיצה על הקישור בתחתית הדף לאחר שהגיבוי יסתיים בהצלחה.<br /><br />קובץ ה-ZIP ישמר בתיקית ה-Index שלך עד שתסיר אותו בצורה ידנית.<br />";
