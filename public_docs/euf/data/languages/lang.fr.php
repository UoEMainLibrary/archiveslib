<?php
# $Id: lang.fr.php,v 1.40 2005/03/30 23:44:11 yalnifj Exp $
...
$pgv_lang["none"]                       = "Libre";
$pgv_lang["ahnentafel_report"]          = "Tableau généalogique";
...
$pgv_lang["relatives_report"]           = "Tableau de parenté";
...
$pgv_lang["halfsister"]                 = "Demie-sœur";
...
$pgv_lang["first_letter_fname"]         = "Sélectionner la première lettre du nom de famille.";
...
$pgv_lang["fams_charts"]                = "Options famille";
...
$pgv_lang["cut"]                        = "Couper";
$pgv_lang["indis_charts"]               = "Diagrammes";
...
$pgv_lang["fullname"]                   = "Prenom et Nom";
...
$pgv_lang["no_support"]                 = "Votre navigateur est trop ancien pour cette version de PhpGedView. Installez un navigateur plus récent.";
...
$pgv_lang["root_person"]                = "Clé individu racine";
...
$pgv_lang["link_as"]                    = "Relier cet individu à une famille existante comme ";
...
$pgv_lang["no_tab6"]                    = "Aucun élément lié à cet individu.";
...
$pgv_lang["view_person"]                = "Afficher la personne<br />";
...
$pgv_lang["find_individual"]            = "Clé individu";
$pgv_lang["find_familyid"]              = "Clé famille";
$pgv_lang["find_sourceid"]              = "Clé Source";
...
$pgv_lang["upload_help"]                = "Sélectionner un fichier local sur votre ordinateur afin de le charger sur le serveur dans le répertoire";
...
$pgv_lang["research_log"]               = "Journal des recherches";
...
$pgv_lang["rela_husb"]                  = "Parenté avec l'épous";
...
$pgv_lang["find_media"]                 = "Rechercher un objet MultiMedia";
...
$pgv_lang["find_family"]                = "Clé famille";
$pgv_lang["find_fam_list"]              = "Chercher liste famille";
...
$pgv_lang["pls_note01"]                 = "Attention : le système distingue MAJUSCULES et minuscules!";
$pgv_lang["min6chars"]                  = "Le mot de passe doit comporter au moins 6 caractères";
$pgv_lang["pls_note02"]                 = "Attention : le mot de passe ne doit contenir que des lettres et des chiffres. Les autres caractères sont mal reconnus par certains systèmes et peuvent empêcher l'accès.";
$pgv_lang["pls_note03"]                 = "Cette adresse courriel doit être vérifiée avant d'activer le compte. Elle ne sera pas affichée sur le site. Vous recevrez un message à cette adresse avec les informations d'enregistrement de votre compte.";
$pgv_lang["emailadress"]                = "Adresse courriel";
$pgv_lang["pls_note04"]                 = "Les champs marqués d'un * sont obligatoires.";
$pgv_lang["pls_note05"]                 = "Après vérification de vos réponses, un message de confirmation sera envoyé à l'adresse que vous indiquez sur cette page. Avec ce message de confirmation, vous pourrez activer votre compte; si l'activation n'est pas faite dans les sept jours, la demande sera annulée. Pour utiliser ce site, vous devez connaître votre identificateur de connexion et votre mot de passe. Vous devez indiquer une adresse courriel valide sur cette page afin de recevoir un message de confirmation.<br /><br />En cas de problème d'enregistrement d'un compte sur ce site, merci de soumettre votre demande à l'administrateur.";

$pgv_lang["mail01_line01"]              = "Bonjour #user_fullname# ...";
$pgv_lang["mail01_line02"]              = "Une demande a ete adressee a ( #SERVER_NAME# ) pour une connexion avec votre adresse courriel ( #user_email# ).";
$pgv_lang["mail01_line03"]              = "Les informations suivantes ont ete utilisees.";
$pgv_lang["mail01_line04"]              = "Merci de cliquer sur le lien ci-dessous et de renseigner les champs demandes pour verifier votre compte et l'adresse courriel.";
$pgv_lang["mail01_line05"]              = "Si vous n'avez pas demande ces informations vous pouvez supprimer ce message.";
$pgv_lang["mail01_line06"]              = "Vous ne recevrez plus de messages de ce systeme parce que ce compte sera supprime sans repons de votre part sous 7 jours. Ce message ne comporte volontairement aucun accent pour etre lu facilement par tous les logiciels de messagerie.";
$pgv_lang["mail01_subject"]             = "Votre inscription sur #SERVER_NAME#";

$pgv_lang["mail02_line01"]              = "Bonjour a l'administrateur ...";
$pgv_lang["mail02_line02"]              = "Un nouvel utilisateur s'est inscrit sur ( #SERVER_NAME# ).";
$pgv_lang["mail02_line03"]              = "L'utilisateur a recu un message avec les informations necessaires a la verification de son compte.";
$pgv_lang["mail02_line04"]              = "Des que l'utilisateur aura fait la verification vous serez informe par message afin que vous puissiez l'autoriser a se connecter a votre site.";
$pgv_lang["mail02_line04a"]			= "Vous serez averti par courriel lorsque l'utilisateur aura fait la verification de son compte. Il pourra se connecter sans action de votre part.";
$pgv_lang["mail02_subject"]             = "Nouvelle inscription sur #SERVER_NAME#";

$pgv_lang["hashcode"]                   = "Code de verification";
...
$pgv_lang["mail03_line01"]              = "Bonjour a l'administrateur ...";
$pgv_lang["mail03_line02"]              = "#newuser[username]# ( #newuser[fullname]# ) a verifie les informations de son inscription.";
$pgv_lang["mail03_line03"]              = "Merci de cliquer sur le lien ci-dessous pour vous connecter au site et donner a l'utilisateur l'autorisation de se connecter.";
$pgv_lang["mail03_line03a"]			= "L'utilisateur peut maintenant se connecter sans action de votre part.";
$pgv_lang["mail03_subject"]             = "Nouvelle verification sur #SERVER_NAME#";
...
$pgv_lang["pls_note11"]                 = "Pour restaurer votre mot de passe, fournissez votre nom d'utilisateur PhpGedView sur ce site et l'adresse courriel associée à ce compte.<br /><br />Vous recevrez par courriel une URL spéciale qui contiendra un code de confirmation de votre compte. Vous pourrez alors changer votre mot de passe et vous connecter.<br /><br />Par mesure de sécurité, vous ne devez fournir votre code de confirmation à personne, même pas aux administrateurs de ce site (ils ne vous le demanderont pas).<br /><br />Si vous avez besoin d'aide de la part de l'administrateur du site, faites une demande d'assistance.";
$pgv_lang["enter_email"]                = "Vous devez entrer une adresse courriel.";

$pgv_lang["mail04_line01"]              = "Bonjour #user_fullname# ...";
$pgv_lang["mail04_line02"]              = "Un nouveau mot de passe a ete demande pour votre compte!";
$pgv_lang["mail04_line03"]              = "Recommandation";
$pgv_lang["mail04_line04"]              = "Cliquez maintenant sur le lien ci-dessous, connectez-vous avec le nouveau mot de passe et, par precaution, changez-le immediatement.";
$pgv_lang["mail04_subject"]             = "Demande d'informations pour #SERVER_NAME#";

$pgv_lang["pwreqinfo"]                  = "Bonjour...<br /><br />Un message a ete envoye a l'adresse (#user[email]#) avec le nouveau mot de passe.<br /><br />Merci de vérifier votre messagerie car vous devriez recevoir ce message dans les prochaines minutes.<br /><br />Recommandation:<br /><br />Après avoir récupéré ce message, connectez-vous à ce site et changez votre mot de passe pour conserver l'integrite de vos donnees.";
...
$pgv_lang["you_may_login"]              = " a ete approuve par l'administrateur du site. Vous pouvez maintenant vous connecter au site PhpGedView par ce lien";
$pgv_lang["welcome_text_auth_mode_1"]   =	"<b>BIENVENUE</b><br /><br />L'accès à ce site est autorisé à tous les visiteurs ayant un compte.<br />Si vous avez déjà un compte, vous pouvez vous connecter.<br /><br />Sinon, remplissez le formulaire de demande de compte.<br />Après vérification, l'administrateur activera votre compte.<br />Vous recevrez un message d'information.";
$pgv_lang["welcome_text_auth_mode_2"]   =	"<b>BIENVENUE</b><br /><br />L'accès à ce site est réservé aux utilisateurs <b>autorisés</b>.<br />Si vous avez déjà un compte, vous pouvez vous connecter.<br /><br />Sinon, remplissez le formulaire de demande de compte.<br />Après vérification, l'administrateur acceptera ou refusera votre demande.<br />Vous recevrez un message d'information.";
...
$pgv_lang["add_main_block"]             = "Ajouter un bloc à la section principale...";
$pgv_lang["add_right_block"]            = "Ajouter un bloc à la section de droite...";
...
$pgv_lang["upgrade_util"]               = "Utilitaire de mise à jour des versions";
$pgv_lang["no_upgrade"]                 = "Aucun fichier à mettre à jour.";
$pgv_lang["use_version"]                = "Vous utilisez la  version";
$pgv_lang["current_version"]            = "Version stable";
$pgv_lang["upgrade_download"]           = "Téléchargement";
$pgv_lang["upgrade_tar"]                = "TAR";
$pgv_lang["upgrade_zip"]                = "ZIP";
$pgv_lang["latest"]                     = "Vous utilisez la dernière version de PhpGedView.";
$pgv_lang["location"]                   = "Emplacement des fichiers Upgrade";
$pgv_lang["include"]                    = "Comprenant";
$pgv_lang["options"]                    = "Options";
$pgv_lang["inc_phpgedview"]             = " PhpGedView";
$pgv_lang["inc_languages"]              = " Langues";
$pgv_lang["inc_config"]                 = " Fichier de configuration";
$pgv_lang["inc_researchlog"]            = " Researchlog";
$pgv_lang["inc_index"]                  = " Fichiers d'index";
$pgv_lang["inc_themes"]                 = " Thèmes";
$pgv_lang["inc_docs"]                   = " Manuels";
$pgv_lang["inc_privacy"]                = " Fichiers des restrictions d'accès";
$pgv_lang["inc_backup"]                 = " Créer une sauvegarde";
$pgv_lang["upgrade_help"]               = " Aidez-moi";
$pgv_lang["cannot_read"]                = "Impossible de lire le fichier";
$pgv_lang["not_configured"]             = "PhpGedView n'a pas été configuré.";
$pgv_lang["location_upgrade"]           = "Indiquer l'emplacement de vos fichiers Upgrade.";
$pgv_lang["new_variable"]               = "Nouvelles variables trouvées";
$pgv_lang["config_open_error"]          = "Impossible d'ouvrir le fichier de configuration.";
$pgv_lang["gedcom_config_write_error"]  = "Impossible d'écrire dans le fichier de configuration GEDCOM.";
$pgv_lang["config_update_ok"]           = "Votre fichier de configuration a été mis à jour.";
$pgv_lang["config_uptodate"]            = "Votre fichier de configuration est à jour.";
$pgv_lang["processing"]                 = "Traitement en cours...";
$pgv_lang["privacy_open_error"]         = "Impossible d'ouvrir le fichier [#PRIVACY_MODULE#].";
$pgv_lang["privacy_write_error"]        = "Impossible d'écrire dans le fichier [#PRIVACY_MODULE#].<br />Vérifier les droits en écriture sur le fichier.<br />Les droits peuvent être rétablis après l'écriture du fichier.";
$pgv_lang["privacy_update_ok"]          = "Votre fichier [#PRIVACY_MODULE#] a été mis à jour.";
$pgv_lang["privacy_uptodate"]           = "Votre fichier [#PRIVACY_MODULE#] est à jour.";
$pgv_lang["heading_privacy"]            = "Fichiers des restrictions d'accès";
$pgv_lang["heading_phpgedview"]         = "Fichiers PhpGedView";
$pgv_lang["heading_image"]              = "Fichiers d'images";
$pgv_lang["heading_index"]              = "Fichiers d'index";
$pgv_lang["heading_language"]           = "Fichiers de langues";
$pgv_lang["heading_theme"]              = "Fichiers de thème";
$pgv_lang["heading_docs"]               = "Manuels";
$pgv_lang["heading_researchlog"]        = "Fichiers «Research Log»";
$pgv_lang["heading_researchloglang"]    = "Fichiers de langues «Research Log»";
$pgv_lang["copied_success"]             = "copié avec succès.";
$pgv_lang["backup_copied_success"]      = "fichier de sauvegarde créé avec succès.";
$pgv_lang["folder_created"]             = "Dossier créé";
$pgv_lang["process_error"]              = "Erreur de traitement sur cette page.";
$pgv_lang["upgrade_completed"]          = "Mise à jour terminée";
$pgv_lang["start_using_upgrad"]         = "Démarrer la version";
...
$pgv_lang["family_group_report"]        = "Rapport «famille»";
$pgv_lang["page"]                       = "Page";
$pgv_lang["of"]                         = "de";
$pgv_lang["enter_famid"]                = "Clé famille";
...
$pgv_lang["individual_report"]          = "Rapport «Individu»";
$pgv_lang["enter_pid"]                  = "Clé individu";
$pgv_lang["individual_list_report"]     = "Rapport «Liste individus»";
...
$pgv_lang["birthdate1"]                 = "Naissance entre le";
$pgv_lang["birthdate2"]                 = "et le";
...
$pgv_lang["gen_ancestry_chart"]         = "Tableau d'ascendance sur #PEDIGREE_GENERATIONS# générations";
$pgv_lang["chart_style"]                = "Style de présentation";
$pgv_lang["ancestry_list"]              = "Liste d'ascendance";
$pgv_lang["ancestry_booklet"]           = "Livret d'ascendance";
...
//-- FAN CHART
$pgv_lang["fan_chart"]                  = "Roue d'ascendance";
$pgv_lang["gen_fan_chart"]              = "Roue d'ascendance sur #PEDIGREE_GENERATIONS# générations";
