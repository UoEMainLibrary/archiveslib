...
/*=================================================
   ...
   Comments:	Russian Language file for PhpGedView.
   		CP-1251 not to be used in multi-language environment.
   Change Log:	9/24/02 - File Created
   		1/2/03 - Translated into Russian
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: lang.ru.php,v 1.121 2003/12/25 13:46:47 kurtnorgaz Exp $
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/lang.ru.extra.php")) require $PGV_BASE_DIRECTORY . "languages/lang.ru.extra.php";
