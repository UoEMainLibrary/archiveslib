...
/*=================================================
   ...
   Comments:	Polish Language file for PHPGedView
   Change Log:	3/3/03 - File Created by Michael Paluchowski, http://genealogy.nethut.pl
   		5/11/03 - File updated by Tymoteusz Motylewski, www.motylewscy.com
...
===================================================*/
# $Id: lang.pl.php,v 1.19 2005/04/12 17:56:09 yalnifj Exp $
...
$pgv_lang["import_multiple"]			= "Importować i pracować z wieloma GEDCOMami";
...
$pgv_lang["validate_gedcom"]	= "Sprawdź poprawność GEDCOMu";
...
//-- GEDCOM edit utility
$pgv_lang["check_delete"]			= "Czy na pewno chcesz usunąć tą informację z GEDCOMu?";
...
$pgv_lang["now_import"]				= "Teraz możesz zaimportować dane z GEDCOMu do phpGedView klikając na odnośnik poniżej.";
...
$pgv_lang["gedcom_favorites"]	= "Główne postacie GEDCOMu";
...
$pgv_lang["todays_events_descr"]	= "Blok tego dnia w historii pokazuje listę wydarzeń z aktywnego GEDCOMu, których rocznica przypada na dany dzień. W przypadku braku takich wydarzeń blok nie jest pokazywany. Na stronie MyGedView blok ten wyświetla jedynie żyjące osoby. Na stronie powitalnej wyświetlone zostaną wszystkie osoby.";
...
$pgv_lang["random_media_descr"]		= "Blok losowych multimediów wyświetla pojedyncze zdjęcie lub inny obiekt medialny z aktywnego GEDCOMu, wraz z przypisaną mu osobą.";
...
$pgv_lang["block_top10_title"]		= "Najpowrzechniejsze nazwiska";
...
$pgv_lang["example_date"]		= "Przykład nieprawidłowej daty w twoim GEDCOMie:";
...
$pgv_lang["click_to_add_media"]		= "Kliknij aby dodać multimedia z listy do GEDCOMu #GEDCOM#";
...
$pgv_lang["invalid_header"]		= "Wykryto linie przed nagłówkiem GEDCOMu (0 HEAD). Podczas oczyszczania zostaną one usunięte.";
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/lang.pl.extra.php")) require $PGV_BASE_DIRECTORY . "languages/lang.pl.extra.php";
