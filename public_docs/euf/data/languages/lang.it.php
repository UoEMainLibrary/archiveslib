...
/*=================================================
   ...
   Comments: Italian Language file for PhpGedView
   Change Log: 20/01/03 - File Created
               21/04/05 - +297 Records Translated (Lorenzo Simionato)
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: lang.it.php,v 1.23 2005/04/28 15:05:49 yalnifj Exp $
...
$pgv_lang["error_header"]   = "Il file GEDCOM, \$GEDCOM, non esiste nella posizione specificata.";
...
$pgv_lang["cart_is_empty"]   = "Il carrello ritagli dell'alberoe' vuoto.";
$pgv_lang["id"]        = "ID";
...
$pgv_lang["message_email1"]		= "Il messaggio seguente ti e' stato inviato da";
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/lang.it.extra.php")) require $PGV_BASE_DIRECTORY . "languages/lang.it.extra.php";
