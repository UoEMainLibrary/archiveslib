...
/*=================================================
   charset=utf-8
   Project:	PhpGedView
   File:	configure_help.pl.php
   Author:	Tymoteusz Motylewski www.motylewscy.com
   Comments:	Polish Language Configure Help file for PhpGedView
   Change Log:	5/11/03 - File Created
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: configure_help.pl.php,v 1.13 2005/04/12 17:55:42 yalnifj Exp $
