...
===================================================*/
# $Id: facts.de.php,v 1.20 2005/05/09 20:20:31 yalnifj Exp $
...
$factarray["_PGVU"]	= "Zuletzt geändert durch";
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/facts.de.extra.php")) require $PGV_BASE_DIRECTORY . "languages/facts.de.extra.php";
