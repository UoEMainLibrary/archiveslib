...
/*=================================================
   ...
   File:	facts.zh.php
   Author:	John Finlay
   Comments:	Defines an array of GEDCOM codes and the chinese name facts that they represent.
...
ten	十
===================================================*/
# $Id: facts.zh.php,v 1.8 2003/12/09 16:23:49 yalnifj Exp $
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/facts.zh.extra.php")) require $PGV_BASE_DIRECTORY . "languages/facts.zh.extra.php";
