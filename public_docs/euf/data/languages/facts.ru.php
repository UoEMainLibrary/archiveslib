...
/*=================================================
   ...
   Project:	phpGedView
   File:	facts.ru.php
   Authors:	John Finlay, Eugene Fedorov
   Translator: Natalia Anikeeva
   Comments:	Defines an array of GEDCOM codes and the Russian name facts that they
		represent. CP-1251 not to be used in multi-language environment.
   Change Log:	8/5/02 - File Created
		1/2/02 - Translated into Russian
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: facts.ru.php,v 1.8 2003/12/09 16:23:49 yalnifj Exp $
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/facts.ru.extra.php")) require $PGV_BASE_DIRECTORY . "languages/facts.ru.extra.php";
