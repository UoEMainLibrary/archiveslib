...
/*=================================================
	...
	Comments:	Norwegian Language Configure Help file for PhpGedView
	Change Log:	7/1/03 - File Created
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: configure_help.no.php,v 1.52 2005/04/13 20:39:39 eikland Exp $
...
$pgv_lang["enter_db_pass"]				= "På grunn av sikkerhetshensyn så må du skrive inn brukernavnet og passordet ditt for databasen for å endre konfigurasjon-verdiene.";
...
$pgv_lang["CHARACTER_SET_help"] 		= "Dette er din GEDCOM fils tegnsett.  UTF-8 anbefales, og burde fungere for de fleste sider.  Hvis du eksporterer din GEDCOM i IBM Windows tegnsett (codepage), skal du skrive WINDOWS her.<br /><br />NB: PHP støtter IKKE UNICODE (UTF-16) så det nytter ikke å klage over dette til PHP folk :-)";
$pgv_lang["LANGUAGE"] 					= "Språk";
$pgv_lang["LANGUAGE_help"] 				= "Velg det språk din side bruker som utgangspunkt.  Brukerne har mulighet til å ignorere denne innstillingen og istede velge språk selv, enten ved å la brukerens nettleser-språkinnstilling velge, eller ved å velge språk selv på siden, hvis \"Tillat brukere å skifte språk\" = Ja .";
$pgv_lang["ENABLE_MULTI_LANGUAGE"] 		= "Tillat brukere å skifte språk";
$pgv_lang["ENABLE_MULTI_LANGUAGE_help"] = "Settes til 'ja' hvis brukerne skal få lov til å velge et annet språk fra en 'slipp ned'-liste på siden, eller bli styrt av språkinnstillingen i brukernes nettlesere.";
...
$pgv_lang["INDEX_DIRECTORY_help"] 		= "Dette er stien til en - lese- og skrivbar - mappe, hvor PhpGedView skal lagre indekseringsfiler (husk å legge til avsluttende skråstrek \"/\")<br /><br />Dette lagres i \$INDEX_DIRECTORY variablen i config.php filen.";
...
$pgv_lang["SHOW_CONTEXT_HELP_help"]		= "Dette valget vil vise linker med hjelpe-spørsmålstegn på sider etter valgene på de sidene hvor besøkende kan få en hjelpetekst om valgene på sidene.";
...
$pgv_lang["welcome_new"]				= "Ettersom du kan se denne siden, har du lykkes med å installere PhpGedView på nettstedet ditt,<br />og kan nå konfigurere PhpGedView etter dine ønsker.<br />";
$pgv_lang["welcome_new_help"]			= "Dette hjelpevinduet kan hjelpe deg gjennom konfigurasjons-prosessen. Ved inntasting/valg av de forskjellige felt, vil dette vindu inneholde opplysninger om det gjeldende felt. Det er OK å lukke vinduet. For å åpne det igjen, kan du klikke på en av \"?\" spørsmålstegnene ut for det gjeldende felt.";
...
$pgv_lang["bom_check_help"]				= "Dette valget vil sjekke alle språkfilene om koden BOM (Byte Order Mark) finnes i filene.<br />Dersom koden blir funnet, vil den bli fjernet.";
...
$pgv_lang["edit_lang_utility_help"]		= "Her kan du endre innholdet av en språk-fil ved å bruke den engelske teksten som referanse.<br />Innholdet av den originale engelske språk-filen vil bli listet opp sammen med teksten i ditt valgte språk.<br />Ved å klikke på en tekst i språkfilen din, vil et nytt vindu åpnes der du kan gjøre endringer i teksten.";
...
$pgv_lang["export_lang_utility_help"]	= "Her kan du velge et språk og eksportere innholdet i hjelpe-tekstene for konfigurasjon av PhpGedView<br />for å lage en dokumentasjon av programmet på det valgte språket.";
$pgv_lang["export_ok"]					= "Hjelpetekstene er eksportert";
$pgv_lang["compare_lang_utility"]		= "Sammenligning av språk-filer";
$pgv_lang["compare_lang_utility_help"]	= "Her kan du sammenligne to språk og få en liste med hva som er forskjellen mellom de ulike språk-filene.<br /><br />Se filen [<a href=\"languages\/LANG_CHANGELOG.txt\" target=\"_blank\">LANG_CHANGELOG.txt</a>] for andre endringer av språk-filer.";
...
$pgv_lang["config_lang_utility_help"]	= "Her kan du aktivere/deaktivere språk som er støttet i PhpGedView.<br /><br />";
...
$pgv_lang["translation_forum"]			= "Link til PhpGedView sitt Forum for oversettere på SourceForge (engelsk)";
$pgv_lang["translation_forum_help"]		= "<center>Ved å trykke på linken over, så åpnes et nytt vindu med PhpGedView sitt <i>Forum for oversettere</i><br />(http://sourceforge.net/forum/forum.php?forum_id=294245),<br />der du kan se på og/eller bidra med aktuelle problemstillinger   :-)</center>";
...
$pgv_lang["hide_translated"]			= "Skjul oversettelse";
...
$pgv_lang["um_bu_explain"] = "Dette verktøyet kan lage en sikkerhetskopi av forskjellige data i PhpGedView.<br /><br />Dataene som du velger å ta sikkerhetskopi av, vil bli samlet i en ZIP-fil, som det også er mulig å laste ned (download) ved å klikke på valget nederst på siden, etter at sikkerhetskopieringen er utført.<br /><br />ZIP-filen vil forbli i Index-mappen din til du fjerner den manuellt.";
...
$pgv_lang["um_bu_usinfo"] = "Bruker-definisjoner, Ramme-innstillinger, Favoritter, Beskjeder, Neyheter";
$pgv_lang["um_mk_bu"] = "Lage sikkerhetskopi";
