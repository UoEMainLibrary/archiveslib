...
/*=================================================
   ...
   Yazar:		John Finlay
   Tercüme:		Kurt Norgaz
   Not:			Defines an array of GEDCOM codes and the turkish name facts that they represent.
   Değişiklikler:	09.04.2003 - Dosya kuruldu
===================================================*/
# $Id: facts.tr.php,v 1.24 2005/04/06 15:40:22 yalnifj Exp $
...
if (file_exists($PGV_BASE_DIRECTORY . "languages/facts.tr.extra.php")) require $PGV_BASE_DIRECTORY . "languages/facts.tr.extra.php";
