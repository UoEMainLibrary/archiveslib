...
/*=================================================
   ...
   File:	lang.cz.php
   Author:	John Finlay
   Comments:	czech Language file for PhpGedView
   Translation:	Jan Hapala
   Change Log:	See LANG_CHANGELOG.txt
2004-01-12 "qm" a přidáno "page_help" (Jans)
2004-01-13 $pgv_lang["individuals"] přidáno pro seznam míst (Jans)
2004-01-15 $pgv_lang["default_form_info"] a $pgv_lang["gedcom_form_info"] přidáno pro doplňující informace k seznamu míst
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: lang.cz.php,v 1.12 2005/04/12 17:55:51 yalnifj Exp $
