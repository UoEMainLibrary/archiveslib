...
===================================================*/
# $Id: configure_help.nl.php,v 1.93 2005/04/15 16:04:03 yalnifj Exp $
...
$pgv_lang["bom_check_help"]			= "Middels deze controle worden BOM's (Byte Order Mark) in de taalbestanden opgespoord en verwijderd.<br /><br />";
$pgv_lang["lang_debug"]			= "Helptekst foutzoeken";
$pgv_lang["lang_debug_help"]	= "Als u deze optie aanzet, worden de namen van de taalvariabelen die in de helptekst worden gebruikt, in het popup-venster getoond. Dit helpt vertalers om de naam van de variabele te bepalen, als de tekst moet worden aangepast.<br /><br />Deze optie blijft alleen gedurende uw huidige PhpGedView-sessie aanstaan.";
...
$pgv_lang["export_lang_utility_help"]	= "Kies een taal om de helpinformatie uit het gekozen configuration_help taalbestand te exporteren naar een documentatiebestand.<br /><br />";
$pgv_lang["export_ok"]				= "Helpinformatie is geëxporteerd.";
$pgv_lang["compare_lang_utility"]	= "Hulpprogramma vergelijking taalbestanden";
$pgv_lang["compare_lang_utility_help"]	= "Deze module vergelijkt twee taalbestanden en maakt een lijst van verschillen. Aangegeven wordt, welke variabelen ten opzichte van het eerste bestand niet meer voorkomen of er juist zijn bijgekomen.<br /><br />In het bestand [<a href=\"languages/LANG_CHANGELOG.txt\" target=\"_blank\">LANG_CHANGELOG.txt</a>] in de languages-map staan nog andere wijzigingen vermeld. Hierin kunt u vinden welke variabelen qua inhoud zijn gewijzigd.<br /><br />";
