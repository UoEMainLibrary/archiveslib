...
/*=================================================
   charset=utf-8
   Project:	phpGedView
   File:	languages/help_text.vi.php
   Author:	Lan Nguyen
   Comments:	Defines an array of GEDCOM codes and the
   Comments:	Vietnamese Language Help-file for PhpGedView
   2005.02.19 "PhpGedView" and "GEDCOM" made consistent across all language files  G.Kroll (canajun2eh)
===================================================*/
# $Id: help_text.vi.php,v 1.2 2005/03/30 23:44:08 yalnifj Exp $
