 ...
 * @version $Id: help_text_vars.php,v 1.65 2005/12/20 19:25:52 yalnifj Exp $
 */
...
if (strstr($_SERVER["PHP_SELF"],"help_text_vars")) {
...
$pgv_lang["upper_mygedview"]			= str2upper($pgv_lang["mygedview"]);
...
//Help
$pgv_lang["help_help_items"]			= "#pgv_lang[help_help]#<br />#pgv_lang[help_page_help]##pgv_lang[help_content_help]##pgv_lang[help_qm_help]#";
...
$pgv_lang["help_edituser.php"]			= "~".str2upper($pgv_lang["myuserdata"])."~<br /><br />#pgv_lang[edituser_my_account_help]#<br />#pgv_lang[more_help]#";
...
$pgv_lang["useradmin_fullname_help"]		= "#pgv_lang[is_user_help]#<br /><br />#pgv_lang[edituser_fullname_help]#";
...
$pgv_lang["index_gedcom_news_ahelp"]		= "#pgv_lang[start_ahelp]#<br />#pgv_lang[index_gedcom_news_adm_help]#<br />#pgv_lang[end_ahelp]#<br />#pgv_lang[index_gedcom_news_help]#";
...
$pgv_lang["help_editlang.php"]			="#pgv_lang[lang_edit_help]#<dl><dt><b>#pgv_lang[translation_forum]#</b></dt><dd>#pgv_lang[translation_forum_help]#</dd><br /><dt><b>#pgv_lang[bom_check]#</b></dt><dd>#pgv_lang[bom_check_help]#</dd><br /><dt><b>#pgv_lang[edit_lang_utility]#</b></dt><dd>#pgv_lang[edit_lang_utility_help]#</dd><br /><dt><b>#pgv_lang[export_lang_utility]#</b></dt><dd>#pgv_lang[export_lang_utility_help]#</dd><br /><dt><b>#pgv_lang[compare_lang_utility]#</b></dt><dd>#pgv_lang[compare_lang_utility_help]#</dd><br /><dt><b>#pgv_lang[add_new_language]#</b></dt><dd>#pgv_lang[add_new_language_help]#</dd></dl>#pgv_lang[more_help]#";
$pgv_lang["help_changelanguage.php"]			="~#pgv_lang[enable_disable_lang]#~<br /><br />#pgv_lang[lang_configure_help]#<dl><dt><b>#pgv_lang[config_lang_utility]#</b></dt><dd>#pgv_lang[config_lang_utility_help]#</dd></dl>#pgv_lang[more_help]#";


//--				G E D C O M
//-- Gedcom Info
$pgv_lang["gedcom_info_help"]			= "<div class=\"name_head\"><center><b>#pgv_lang[help_contents_gedcom_info]#</b></center></div><br />#pgv_lang[def_gedcom_help]#<br /><a href=\"#top\">$UpArrow </a>#pgv_lang[def_gedcom_date_help]#<br /><a href=\"#top\">$UpArrow </a>#pgv_lang[ppp_levels_help]#";
...
//-- Edit Privacy
$pgv_lang["help_edit_privacy.php"]		="~".str2upper($pgv_lang["edit_privacy_title"])."~<br /><br />#pgv_lang[edit_privacy_help]##pgv_lang[more_config_hjaelp]#<br />#pgv_lang[readme_help]#";
...
while (isset($pgv_lang["h$i"])) {
	$pgv_lang["help_contents_help"] .= "#pgv_lang[h$i]#";
	$i++;
}
...
while (isset($pgv_lang["ah$i"])) {
	$pgv_lang["a_help_contents_help"] .= "#pgv_lang[ah$i]#";
	$i++;
}
