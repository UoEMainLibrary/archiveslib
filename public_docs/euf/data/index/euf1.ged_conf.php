 ...
 * @version $Id: config_gedcom.php,v 1.49 2005/08/12 18:49:02 yalnifj Exp $
 */
...
$ENABLE_MULTI_LANGUAGE = false;			//-- set to true to give users the option of selecting a different language from
...
$PEDIGREE_ROOT_ID = "1";				// -- use this line to change the default person who appears on
										// -- the Pedigree tree
...
$CONTACT_EMAIL = "deputyarchivist";		    // -- this is who the user should contact for more information
$CONTACT_METHOD = "messaging2";						// -- the method to allow users to contact you. options are: mailto, messaging, messaging2
$WEBMASTER_EMAIL = "deputyarchivist";		// -- this is who the user should contact in case of errors
$SUPPORT_METHOD = "messaging2";						// -- the method to allow users to contact you. options are: mailto, messaging, messaging2
$HOME_SITE_URL = "http://www.archives.lib.ed.ac.uk/euf/data";     // -- url for your home page
$HOME_SITE_TEXT = "Home";                     // -- name of your site
$FAVICON = "images/favicon.ico";                          // -- change to point to your favicon, either relative or absolute
$THEME_DIR = "themes/xenea/";					// -- directory where display theme files are kept
