 ...
 * @subpackage Admin
 * @see config.php
 * @version $Id: editconfig.php,v 1.91 2005/05/31 11:34:10 canajun2eh Exp $
 */
...
<table class="facts_table">
	...
	<tr>
		...
		<td class="facts_value"><input type="text" name="NEW_DBHOST" value="<?php print $DBHOST?>" size="40" tabindex="<?php $i++; print $i?>" onfocus="getHelp('DBHOST_help');" /></td>
	</tr>
	<tr>
		<td class="facts_label"><?php print $pgv_lang["DBUSER"];?> <a href="#" onclick="return helpPopup('DBUSER_help');"><b>?</b></a></td>
		<td class="facts_value"><input type="text" name="NEW_DBUSER" value="<?php print $DBUSER?>" size="40" tabindex="<?php $i++; print $i?>" onfocus="getHelp('DBUSER_help');" /></td>
	</tr>
	<tr>
		<td class="facts_label"><?php print $pgv_lang["DBPASS"];?> <a href="#" onclick="return helpPopup('DBPASS_help');"><b>?</b></a></td>
		<td class="facts_value"><input type="password" name="NEW_DBPASS" value="" tabindex="<?php $i++; print $i?>" onfocus="getHelp('DBPASS_help');" /></td>
	</tr>
	<tr>
		<td class="facts_label"><?php print $pgv_lang["DBNAME"];?> <a href="#" onclick="return helpPopup('DBNAME_help');"><b>?</b></a></td>
		<td class="facts_value"><input type="text" name="NEW_DBNAME" value="<?php print $DBNAME?>" size="40" tabindex="<?php $i++; print $i?>" onfocus="getHelp('DBNAME_help');" /></td>
	</tr>
	<tr>
		<td class="facts_label"><?php print $pgv_lang["TBLPREFIX"];?> <a href="#" onclick="return helpPopup('TBLPREFIX_help');"><b>?</b></a></td>
		<td class="facts_value"><input type="text" name="NEW_TBLPREFIX" value="<?php print $TBLPREFIX?>" size="40" tabindex="<?php $i++; print $i?>" onfocus="getHelp('TBLPREFIX_help');" /></td>
	</tr>
	</table>
	</div>
	<table class="facts_table">
