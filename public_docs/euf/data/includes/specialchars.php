...
/*=================================================
   charset=utf-8
   Project:	phpGedView
   File:	specialchars.php
   Author:	John Finlay
   Comments:	Special Character tables, for use by JavaScript to input characters
   				that aren't on your keyboard
===================================================*/
# $Id: specialchars.php,v 1.168.2.75 2005/04/20 22:48:41 canajun2eh Exp $
/*
THIS FILE MUST BE SAVED IN UTF-8 ENCODING (or some special characters will be lost)

When updating, be sure to add the language into the array $specialchar_languages, add a case for that language into the switch, and add any new special characters into the default case of the switch near the bottom. 
...
Other sources:
Czech:
http://webdesign.about.com/library/blhtmlcodes-cz.htm
Irish:
offline sources
Hawaiian:
