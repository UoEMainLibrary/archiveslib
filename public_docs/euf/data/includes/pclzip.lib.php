...
//
// --------------------------------------------------------------------------------
// $Id: pclzip.lib.php,v 1.3 2005/03/31 17:40:09 yalnifj Exp $
// --------------------------------------------------------------------------------
...
//	if ($p_local_header['filename_len'] != $p_central_header['filename_len']) {
	if ($p_local_header['size'] != $p_central_header['size']) {        //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, 'Bad check "filename_len" : TBC To Be Completed');
	}
