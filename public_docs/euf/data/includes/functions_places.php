 ...
 * @package PhpGedView
 * @subpackage Edit
 * @version $Id: functions_places.php,v 1.2 2005/03/30 23:43:27 yalnifj Exp $
 */
...
function print_place_subfields($element_id) {
	...
	$cols=40;
	print "&nbsp;<a href=\"javascript: ".$pgv_lang["show_details"]."\" onclick=\"expand_layer('".$element_id."_div'); toggleplace('".$element_id."'); return false;\"><img id=\"".$element_id."_div_img\" src=\"".$PGV_IMAGE_DIR."/".$PGV_IMAGES["plus"]["other"]."\" border=\"0\" width=\"11\" height=\"11\" alt=\"\" title=\"\" />&nbsp;</a>";
	...
	for ($i=0; $i<count($plac_label); $i++) {
		...
		if (in_array($plac_label[$i], array("Country", $factarray["CTRY"]))) {
			$cols="8";
...
//			print " acdropdown=\"true\" autocomplete_complete=\"true\"";
			...
			if ($icountry<$i and $i<=$icity) print " <img id=\"".$subtagid."_auto\" name=\"".$subtagname."_auto\" src=\"images/autocomplete.gif\" alt=\"autocompletion active\" title=\"autocompletion active\" /> ";
