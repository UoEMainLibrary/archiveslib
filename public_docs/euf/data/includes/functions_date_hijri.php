 ...
 *
 * @package PhpGedView
 * @version $Id: functions_date_hijri.php,v 1.3 2005/05/22 01:25:58 sfezz Exp $
 */

/**
 * security check to prevent hackers from directly accessing this file.
 */
if (strstr($_SERVER["PHP_SELF"],"functions_date_hijri.php")) {
...
/**
 * Function that returns the days of the week in Arabic
 *
 * @return array An array of strings with the key being the english three letter abbreviation of the day of the week, 
 *                        and the value the Arabic translation.
 * @author sfezz (sfezz@users.sourceforge.net).
 */
function getArabicWeekDayNames()
{
	return array("Sat"=>"السبت", 
	         "Sun"=>"الأحد", 
	         "Mon"=>"الأثنين", 
	         "Tue"=>"الثلاثاء", 
	         "Wed"=>"الأربعاء", 
...
/**
 * Function that returns the translation for AM or PM in Arabic.
 *
 * @return array An array of strings with the key being the english two letter abbreviation am and pm, 
 *                        and the value the Arabic translation.
 * @author sfezz (sfezz@users.sourceforge.net).
 */
function getArabicAMPM()
{
	return array('am'=>'صباح','pm'=>'مساء'); 
}
 
/**
 * Function that returns the names of the Hijri calendar months in Arabic.
 *
 * @return array An array of strings with the twelve Arabic Hijri months as elements.
 * @author sfezz (sfezz@users.sourceforge.net).
 */
function getArabicHijriMonthNames()
{
	return array("محرّم", 
				"صفر", 
				"ربيع الأول", 
...
/**
 * Function that returns the names of the Gregorian calendar months in Arabic.
 *
 * @return array An array of strings with the twelve Gregorian month names in Arabic as elements.
 * @author sfezz (sfezz@users.sourceforge.net).
 */
function getArabicGregorianMonthNames()
{
	return array("ياناير",
			"فبراير",
			"مارس",
...
function getHijri($d, $m, $y) 
{
	...
	$hjMonth = getArabicHijriMonthNames();
...
function getArabic($d, $m, $y) 
{
	...
	$arMonth = getArabicGregorianMonthNames();
