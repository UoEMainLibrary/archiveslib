...
***********************************************************/
# $Id: imageview.php,v 1.30 2005/05/06 14:43:43 yalnifj Exp $
require("config.php");
...
if ((empty($filename))||(!@fclose(@fopen(filename_decode($filename),"r")))) print "<span class=\"error\">Missing Image File $filename</span>";
else {
