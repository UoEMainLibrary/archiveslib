 ...
 *
 * $Id: login_block.php,v 1.3 2005/04/12 17:55:11 yalnifj Exp $
 * @package PhpGedView
 * @subpackage Blocks
 */
 
$PGV_BLOCKS["print_login_block"]["name"]        = $pgv_lang["login_block"];
$PGV_BLOCKS["print_login_block"]["descr"]        = $pgv_lang["login_descr"];
...
function print_login_block($block = true, $config="", $side, $index) {
		global $pgv_lang, $GEDCOM, $GEDCOMS, $command, $PHP_SELF, $QUERY_STRING, $USE_REGISTRATION_MODULE, $LOGIN_URL, $ALLOW_REMEMBER_ME;
