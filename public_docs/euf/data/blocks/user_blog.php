 ...
 *
 * $Id: user_blog.php,v 1.2 2005/03/30 23:43:14 yalnifj Exp $
 * @package PhpGedView
 * @subpackage Blocks
 */
 
$PGV_BLOCKS["print_user_news"]["name"]        = $pgv_lang["user_news_block"];
$PGV_BLOCKS["print_user_news"]["descr"]        = $pgv_lang["user_news_descr"];
...
function print_user_news($block=true, $config="", $side, $index) {
		...
		if ($block) print "</div>\n";
		if (!empty($uname)) print "<br /><a href=\"#\" onclick=\"addnews('$uname'); return false;\">".$pgv_lang["add_journal"]."</a>\n";
		print "</div>\n";
		print "</div>";
}
?>