 ...
 *
 * @version $Id: user_welcome.php,v 1.2 2005/03/30 23:43:14 yalnifj Exp $
 * @package PhpGedView
 * @subpackage Blocks
 */

$PGV_BLOCKS["print_welcome_block"]["name"]        = $pgv_lang["welcome_block"];
$PGV_BLOCKS["print_welcome_block"]["descr"]        = $pgv_lang["welcome_descr"];
...
function print_welcome_block($block=true, $config="", $side, $index) {
		global $pgv_lang, $day, $month, $year, $PGV_IMAGE_DIR, $PGV_IMAGES, $user, $GEDCOM, $TIME_FORMAT,$command;

		print "<div id=\"user_welcome\" class=\"block\">\n";
		print "<table class=\"blockheader\" cellspacing=\"0\" cellpadding=\"0\" style=\"direction:ltr;\"><tr>";
		print "<td class=\"blockh1\" >&nbsp;</td>";
		print "<td class=\"blockh2\" ><div class=\"blockhc\">";
		print "<b>".$pgv_lang["welcome"]." ".$user["fullname"]."</b>";
		print "</div></td>";
		...
		print "</tr><tr><td class=\"center\" colspan=\"3\"><a href=\"#\" onclick=\"window.open('index_edit.php?name=".getUserName()."&amp;command=user', '', 'top=50,left=50,width=600,height=550,scrollbars=1,resizable=1');\">".$pgv_lang["customize_page"]."</a>\n";
