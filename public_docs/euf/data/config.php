 ...
 * @subpackage Admin
 * @see editconfig.php
 * @version $Id: config.php,v 1.93 2005/04/15 16:03:59 yalnifj Exp $
 */
...
$DBUSER = "gbuttars";									//-- MySQL database User Name
$DBPASS = "actijij4";									//-- MySQL database User Password
$DBNAME = "speccoll";							//-- The MySQL database name where you want PHPGedView to build its tables
...
$AUTHENTICATION_MODULE = "authentication_mysql.php";	//-- File that contains authentication functions
...
$SERVER_URL = "http://www.archives.lib.ed.ac.uk/euf/data/";								//-- the URL used to access this server
