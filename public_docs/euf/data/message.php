 ...
 * @package PhpGedView
 * @subpackage Admin
 * @version $Id: message.php,v 1.40 2005/05/09 20:20:28 yalnifj Exp $
 */
require("config.php");
...
if ($action=="compose") {
	...
	if ($touser) {
		print "<tr><td></td><td>".str_replace("#TO_USER#", "<b>".$touser["fullname"]."</b>", $pgv_lang["sending_to"])."<br />";
