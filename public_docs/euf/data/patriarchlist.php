 ...
 *
 * @version $Id: patriarchlist.php,v 1.14 2005/07/28 18:39:56 yalnifj Exp $
 * @package PhpGedView
 * @subpackage Lists
 */
...
//else uasort($patrialpha, "itemsort");
...
if ($show_all=="yes" && $alpha != "@"){
	if ($surname_sublist=="yes") print "<br /><a href=\"patriarchlist.php?show_all=yes&amp;surname_sublist=no\">".$pgv_lang["skip_surnames"]."</a>";
 	else print "<br /><a href=\"patriarchlist.php?show_all=yes&amp;surname_sublist=yes\">".$pgv_lang["show_surnames"]."</a>";
}
	...
	print "<br /><a href=\"patriarchlist.php?alpha=$alpha&amp;surname_sublist=yes\">".$pgv_lang["show_surnames"]."</a>";
}
else if ($alpha != "@"){
	if ($surname_sublist=="yes") print "<br /><a href=\"patriarchlist.php?alpha=$alpha&amp;surname_sublist=no\">".$pgv_lang["skip_surnames"]."</a>";
	else print "<br /><a href=\"patriarchlist.php?alpha=$alpha&amp;surname_sublist=yes\">".$pgv_lang["show_surnames"]."</a>";
}
