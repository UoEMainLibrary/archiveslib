...
/**
 * Main FPDF Class to create PDF documents
 */
class FPDF
{
//Private properties
...
function SetFont($family,$style='',$size=0)
{
	...
	else if(!isset($this->fonts[$fontkey])) {
		$family='helvetica';
	}
...
{
	$nf=$this->n;
	foreach($this->diffs as $indexval => $diff)
	{
		//Encodings
		$this->_newobj();
...
{
	foreach($this->images as $indexval => $image)
...
function _putresourcedict()
{
	...
	$this->_out('/Font <<');
	foreach($this->fonts as $indexval => $font)
