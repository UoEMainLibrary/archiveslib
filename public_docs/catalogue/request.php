...
echo "<title>Manuscripts and Archives catalogue: Consultation Request</title>";
		include "includes/cat_header.php";
		include "../includes/lowerheader.php"; ?>
        <div><a href="/">Special Collections: Archival Resources</a> :: <a href="/catalogue/">Search the Catalogue</a></div>
...
if (fnmatch("GB-237-Coll-*", $_GET['refid'])) {
			...
			$replacewith2 = "Coll-";
			$refstr = str_replace($replaceable2, $replacewith2, $tempstr); }
			elseif (fnmatch("EUA-*", $_GET['refid']))  {
			$replaceable2 = "EUA/";
			$replacewith2 = "EUA ";
			$refstr = str_replace($replaceable2, $replacewith2, $tempstr);
			}
			elseif (fnmatch("BAI-*", $_GET['refid']))  {
			$replaceable2 = "BAI/";
			$replacewith2 = "BAI ";
			$refstr = str_replace($replaceable2, $replacewith2, $tempstr);
			}
