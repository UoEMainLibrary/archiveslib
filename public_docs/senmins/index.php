...
<?php include "/home/lib/lacddt/archives/mgt_config/sql.php";
echo "<h1>Index to Minutes of the Senatus Academicus 1733-1855</h1>";
...
echo "<p>The first seven volumes of <a href='http://archives.collections.ed.ac.uk/repositories/2/archival_objects/17098'>minutes</a> have a combined index which can be searched here.</p><br />";
