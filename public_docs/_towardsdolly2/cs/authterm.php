...
if ($table == "cms_auth_subj") {
     ...
     <subject authfilenumber='<?php echo $results['id'] ?>' source='<?php echo $results['source'] ?>'><?php echo $results['term'] ?></subject>
...
if ($table == "cms_auth_genr") {
     ...
     <genre authfilenumber='<?php echo $results['id'] ?>' source='<?php echo $results['source'] ?>'><?php echo $results['term'] ?></genre>
