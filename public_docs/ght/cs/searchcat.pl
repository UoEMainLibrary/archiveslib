...
my $repository_root = "/home/archives/ght_catalogue_repository";
# my $cat_root = "/home/archives/public_docs/catalogue";
my $cat_root = "/home/archives/public_docs/ght";
my $doc_root = "/home/archives/public_docs/ght";
# my $view_isad_url = "http://www.archives.lib.ed.ac.uk/catalogue/cs/viewcat.pl";
my $view_isad_url = "http://www.archives.lib.ed.ac.uk/ght/cs/viewcat.pl";
...
open(HTML_INPUT, "$doc_root/includes/footer.php");
while (<HTML_INPUT>) {
  print $_;
}
}
...
open(HTML_INPUT, "$doc_root/includes/top_header.php");
while (<HTML_INPUT>) {
  print $_;
}
...
open(HTML_INPUT, "$doc_root/includes/lower_header.php");
while (<HTML_INPUT>) {
  print $_;
}
