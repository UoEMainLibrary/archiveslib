...
echo "<madsCollection xmlns=\"http://www.loc.gov/mads/\"
	...
	echo "<country>".$results['country'];
		...
		echo "<county>".$results['county'];
			echo "<island>".$results['island'];			
				if ($results['term'] <>'') {
				echo "<area>".$results['term']."</area>";
				}
			echo "</island>";
		echo "</county>";
		}
...
echo "<madsCollection xmlns=\"http://www.loc.gov/mads/\"
	...
	echo "<namePart type=\"terms of address\">".$terms_of_address2."</namePart>";
