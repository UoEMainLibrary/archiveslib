...
## show up link on all but front page
 if (isset ($view)) { echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities'><img src='includes/up.gif' alt='Up to Authorities Menu' border='0' /></a>"; }
######################################################################################
...
echo "<tr><td class='label'>Personal names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=perslist'>List, A-Z</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=perslist&amp;created_for=CW'>List, A-Z (CW only)</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=persadd'>Add new term</a></td></tr>";
echo "<tr><td class='label'>Family names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=famlist'>List, A-Z</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=famlist&amp;created_for=CW'>List, A-Z (CW only)</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=famadd'>Add new term</a></td></tr>";
echo "<tr><td class='label'>Corporate names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corplist'>List, A-Z</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corplist&amp;created_for=CW'>List, A-Z (CW only)</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corpadd'>Add new term</a></td></tr>";
...
echo "<tr><td class='label'>Place names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geoglist'>List, A-Z</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geoglist&amp;created_for=CW'>List, A-Z (CW only)</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogadd'>Add new term</a></td></tr>";
...
<h2>Search existing terms</h2>
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
<input type="hidden" name="type" value="pers" />
<input type="hidden" name="view" value="search" />
<input type="text" name="searchterm" size="55" />
<input type="submit" value="Personal name" />
</form>
<br />
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
...
<input type="hidden" name="view" value="search" />
<input type="text" name="searchterm" size="55" />
<input type="submit" value="Corporate name" />
</form>
<br />
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
...
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
<input type="hidden" name="type" value="geog" />
<input type="hidden" name="view" value="search" />
<input type="text" name="searchterm" size="55" />
<input type="submit" value="Place name" />
</form>
<br />
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
<input type="hidden" name="type" value="genr" />
<input type="hidden" name="view" value="search" />
<input type="text" name="searchterm" size="55" />
...
if ($_GET['type'] == "pers") { $sql_str="SELECT * FROM $table WHERE given_name LIKE '%$searchterm%' OR family_name LIKE '%$searchterm%' AND suppress IS NULL ORDER BY persterm ASC"; }

elseif ($_GET['type'] == "fam") { $sql_str="SELECT * FROM $table WHERE family_name LIKE '%$searchterm%' AND suppress IS NULL ORDER BY famterm ASC"; }

elseif ($_GET['type'] == "corp") { $sql_str="SELECT * FROM $table WHERE primary_name LIKE '%$searchterm%' OR secondary_name LIKE '%$searchterm%' AND suppress IS NULL ORDER BY primary_name ASC, secondary_name ASC"; }

elseif ($_GET['type'] == "geog") { $sql_str="SELECT * FROM $table WHERE term LIKE '%$searchterm%' OR island LIKE '%$searchterm%' OR city LIKE '%$searchterm%' OR territory LIKE '%$searchterm%' OR county LIKE '%$searchterm%' OR country LIKE '%$searchterm%' OR continent LIKE '%$searchterm%' AND suppress IS NULL ORDER BY term ASC, island ASC, city ASC, county ASC, country ASC"; }
...
echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=".$_GET['type']."view&amp;id=".$results['id']."'>".$results['term']." ".$results['island']." ".$results['city']." ".$results['territory']."  ".$results['county']." ".$results['country']."</a>";
}
else {
...
echo "<tr><td class='label'><em>Old NCA Term</em></td><td><em>".$results['persterm']."</em></td></tr>";
...
$varsearch = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
while ($results2 = mysql_fetch_array($varsearch)):
...
$prefsearch = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
$results2 = mysql_fetch_array($prefsearch);
...
$navsearch1 = mysql_db_query($dbname, $sql_str1, $id_link) or die("Search Failed!");
$results1 = mysql_fetch_array($navsearch1);
$prev = $results1['id'];

$sql_str2="SELECT id FROM cms_auth_pers WHERE id > $id AND suppress IS NULL ORDER BY ID ASC LIMIT 1";
$navsearch2 = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
$results2 = mysql_fetch_array($navsearch2);
$next = $results2['id'];
...
<div style="margin-left:550px;"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=authorities&amp;view=persdelete&id=<? echo $results['id'] ?>">Delete term</a></div>
...
<table summary="">
<tr><td class="label">Old NCA Term</td><td><? echo $results['persterm'] ?></td></tr>
<tr><td class="label">Current NCA Term</td><td><? echo $nca_str ?></td></tr>
<tr><td class="label">Family name</td><td><input name="family_name" size="75" type="text" value="<? echo $results['family_name'] ?>" /></td></tr>
<tr><td class="label">Given name(s)</td><td><input name="given_name" size="75" type="text" value="<? echo $results['given_name'] ?>" /></td></tr>
<tr><td class="label">Date(s)</td><td><input name="date" size="75" type="text" value="<? echo $results['date'] ?>" /></td></tr>
<tr><td class="label">Terms of address</td><td><input name="terms_of_address" size="75" type="text" value="<? echo $results['terms_of_address'] ?>" /></td></tr>
<tr><td class="label">Description</td><td><input name="description" size="75" type="text" value="<? echo $results['description'] ?>" /></td></tr>
<tr><td class="label">Variant of</td><td>



<?   $var_id = $results['variant_of'];
	if ($var_id == 0 ) {

     echo "<div>Currently set as: this is the preferred version of the name</div>";
	 } else {

     $sql_str2="SELECT * FROM cms_auth_pers where id='$var_id' AND suppress IS NULL";
	 $authsearch2 = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
	 $results2 = mysql_fetch_array($authsearch2);		 
include "nca_name_form_p.php";
echo "<div>Currently set as:  ".$nca_str2."</div>";
}
echo "Change to: <select style='width:409px;' name='variant_of'>";
echo "<option value='0'>this is the preferred version of the name</option>";
	$sql_str3="SELECT * FROM cms_auth_pers ORDER BY family_name ASC, given_name ASC";
	 $authsearch3 = mysql_db_query($dbname, $sql_str3, $id_link) or die("Search Failed!");
while ($results3 = mysql_fetch_array($authsearch3)):
include "nca_name_form_p.php";
...
<tr><td class="label">Use for</td><td><textarea cols="61" rows="2" name="use_for"><? echo $results['use_for'] ?></textarea></td></tr>
<tr><td class="label">Source(s)</td><td><textarea cols="61" rows="2" name="source"><? echo $results['source'] ?></textarea></td></tr>
<tr><td class="label">Language code</td><td><input name="lang_code" size="75" type="text" value="eng" />
<tr><td class="label">Notes</td><td><textarea cols="61" rows="2" name="notes"><? echo $results['notes'] ?></textarea></td></tr></td></tr>
<tr><td class="label">Created for</td><td>
<select name="created_for">
<option value="<? echo $results['created_for'] ?>"><? echo $results['created_for'] ?></option>
<option value="CW">CW</option>
<option value="TD">TD</option>
<option value="GHT">GHT</option>
<option value="EUA">EUA</option>
<option value="AMS">AMS</option>
<option value="LHSA-Dott">LHSA-Dott</option>
</select>
</td></tr>
</table> 
...
$family_name = mysql_real_escape_string($_GET['family_name']);
$given_name = mysql_real_escape_string($_GET['given_name']);
$date = $_GET['date'];
$terms_of_address = mysql_real_escape_string($_GET['terms_of_address']);
$description = mysql_real_escape_string($_GET['description']);
$variant_of = mysql_real_escape_string($_GET['variant_of']);
$use_for = mysql_real_escape_string($_GET['use_for']);
...
##echo "<tr><td><strong>Personal names already in database</strong><br /><textarea cols='40' rows='30' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly' wrap='off'>";
##while ($results = mysql_fetch_array($perssearch)):
##include "nca_name_form_p.php";
##echo $nca_str ."\n";
##endwhile;
...
<? ##$sql_str2="SELECT * FROM cms_auth_pers WHERE suppress IS NULL ORDER BY family_name ASC, given_name ASC";

	 ##$authsearch = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
##while ($results2 = mysql_fetch_array($authsearch)):
##include "nca_name_form_p.php";
...
mysql_query($sql_str) or die ("<p>Enter person failed!</p>");


$sql_str="SELECT * FROM cms_auth_pers WHERE family_name LIKE '$family_name' AND given_name LIKE '$given_name' AND suppress IS NULL ORDER BY id DESC";
$perssearch = mysql_db_query($dbname, $sql_str, $id_link) or die("<p>Search Failed!</p>");
$results = mysql_fetch_array($perssearch);
include "nca_name_form_p.php";
echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=persview&amp;id=".$results['id']."'>".$nca_str."</a> has been added</p>";

echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=persadd'>Add another new personal name</a>";
...
mysql_query($sql_str) or die ("Delete person failed!");
...
elseif ($view == "famlist") {
	 ...
	 $famsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
...
echo "<table border='1' cellpadding='5'>";
while ($results = mysql_fetch_array($famsearch)):
...
$sql_str="SELECT * FROM cms_auth_fam WHERE id=$id AND suppress IS NULL";
	 ...
	 echo "<h3>Family</h3>";
echo "<table cellpadding='5'cellspacing='5'>";
$results = mysql_fetch_array($famsearch);
echo "<tr><td class='label'>ID</td><td>".$results['id']."</td></tr>";
echo "<tr><td class='label'>Family name</td><td>".$results['family_name']."</td></tr>";
...
$sql_str="SELECT * FROM cms_auth_fam WHERE id=$id AND suppress IS NULL";
 ...
 ?>
<h3>Edit term: Person</h3>
<div style="margin-left:550px;"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=authorities&amp;view=famdelete&id=<? echo $results['id'] ?>">Delete term</a></div>
...
<table summary="">
<tr><td class="label">Family name</td><td><input name="family_name" size="75" type="text" value="<? echo $results['family_name'] ?>" /></td></tr>
<tr><td class="label">Title</td><td><input name="title" size="75" type="text" value="<? echo $results['title'] ?>" /></td></tr>
<tr><td class="label">Territorial distinction</td><td><input name="territorial_distinction" size="75" type="text" value="<? echo $results['territorial_distinction'] ?>" /></td></tr>
<tr><td class="label">Use for</td><td><textarea cols="61" rows="2" name="use_for"><? echo $results['use_for'] ?></textarea></td></tr>
<tr><td class="label">Source(s)</td><td><textarea cols="61" rows="2" name="source"><? echo $results['source'] ?></textarea></td></tr>
<tr><td class="label">Language code</td><td><input name="lang_code" size="75" type="text" value="<? echo $results['lang_code'] ?>" /></td></tr>
<tr><td class="label">Notes</td><td><textarea cols="61" rows="2" name="use_for"><? echo $results['notes'] ?></textarea></td></tr>
<tr><td class="label">Created for</td><td>
<select name="created_for">
<option value="<? echo $results['created_for'] ?>"><? echo $results['created_for'] ?></option>
<option value="CW">CW</option>
...
$territorial_distinction = mysql_real_escape_string($_GET['territorial_distinction']);
$use_for = mysql_real_escape_string($_GET['use_for']);
$source = mysql_real_escape_string($_GET['source']);
$lang_code = $_GET['lang_code'];
$notes = mysql_real_escape_string($_GET['notes']);
...
mysql_query($sql_str) or die ("Update family failed!");
...
echo "<table align='right' width='300'>";
echo "<tr><td><strong>Family names already in database</strong><br /><textarea cols='40' rows='30' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly' wrap='off'>";
while ($results = mysql_fetch_array($famsearch)):
include "nca_name_form_f.php";
echo $nca_str ."\n";
endwhile;
...
mysql_query($sql_str) or die ("<p>Enter family name failed!</p>");
...
$famsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("<p>Search Failed!</p>");
$results = mysql_fetch_array($famsearch);
include "nca_name_form_f.php";
...
echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=famadd'>Add another new family name</a>";
...
mysql_query($sql_str) or die ("Delete family name failed!");
...
elseif ($view == "corplist") {
	 ...
	 $corpsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	 echo "<h3>Corporate names</h3>";
	 
	  if (isset ($created_for)) {
	 echo "<div>Filtered:".$created_for."</div>";
	 }
	 echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corpadd'>Add new term</a></p>";	 
echo "<table border='1' cellpadding='5'>";
while ($results = mysql_fetch_array($corpsearch)):
...
$sql_str="SELECT * FROM cms_auth_corp WHERE id=$id AND suppress IS NULL";
	 ...
	 $corpsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	 echo "<h3>Corporate name</h3>";
echo "<table cellpadding='5'cellspacing='5'>";
$results = mysql_fetch_array($corpsearch);
include "nca_name_form_c.php";
...
<div style="margin-left:550px;"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=authorities&amp;view=corpdelete&id=<? echo $results['id'] ?>">Delete term</a></div>
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
<input type="hidden" name="view" value="corpupdate" />
<input type="hidden" name="id" value="<? echo $results['id'] ?>" />
<table summary="">
<tr><td class="label">Old NCA Term</td><td><? echo $results['corpterm'] ?></td></tr>
<tr><td class="label">Current NCA Term</td><td><? echo $nca_str ?></td></tr>
<tr><td class="label">Primary name</td><td><input name="primary_name" size="75" type="text" value="<? echo $results['primary_name'] ?>" /></td></tr>
<tr><td class="label">Secondary name</td><td><input name="secondary_name" size="75" type="text" value="<? echo $results['secondary_name'] ?>" /></td></tr>
<tr><td class="label">Date(s)</td><td><input name="date" size="75" type="text" value="<? echo $results['date'] ?>" /></td></tr>
<tr><td class="label">Description</td><td><input name="description" size="75" type="text" value="<? echo $results['description'] ?>" /></td></tr>
<tr><td class="label">Location</td><td><input name="location" size="75" type="text" value="<? echo $results['location'] ?>" /></td></tr>
<tr><td class="label">Variant of</td><td>
...
<tr><td class="label">Use for</td><td><textarea cols="61" rows="2" name="use_for"><? echo $results['use_for'] ?></textarea></td></tr>
<tr><td class="label">Source(s)</td><td><textarea cols="61" rows="2" name="term"><? echo $results['source'] ?></textarea></td></tr>
<tr><td class="label">Language code</td><td><input name="lang_code" size="75" type="text" value="<? echo $results['lang_code'] ?>" /></td></tr>
<tr><td class="label">Notes</td><td><textarea cols="61" rows="2" name="notes"><? echo $results['notes'] ?></textarea></td></tr>
<tr><td class="label">Created for</td><td>
<select name="created_for">
<option value="<? echo $results['created_for'] ?>"><? echo $results['created_for'] ?></option>
<option value="CW">CW</option>
...
$primary_name = mysql_real_escape_string($_GET['primary_name']);
$secondary_name = mysql_real_escape_string($_GET['secondary_name']);
$date = $_GET['date'];
##$terms_of_address = mysql_real_escape_string($_GET['terms_of_address']);
$description = mysql_real_escape_string($_GET['description']);
...
echo "<table align='right' width='300'>";
echo "<tr><td><strong>Corporate names already in database</strong><br /><textarea cols='40' rows='30' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly' wrap='off'>";
while ($results = mysql_fetch_array($corpsearch)):
include "nca_name_form_c.php";	
echo $nca_str ."\n";
endwhile;
...
<select style="width:409px" name="variant_of">
<option value="0"></option>
<? $sql_str2="SELECT * FROM cms_auth_corp WHERE suppress IS NULL ORDER BY primary_name ASC";
...
mysql_query($sql_str) or die ("<p>Enter corporate name failed!</p>");
...
$corpsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("<p>Search Failed!</p>");
$results = mysql_fetch_array($corpsearch);
include "nca_name_form_c.php";
echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corpview&amp;id=".$results['id']."'>".$nca_str."</a> has been added</p>";

echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corpadd'>Add another new corporate name</a>";
...
mysql_query($sql_str) or die ("Delete corporate name failed!");
...
elseif ($view == "subjlist") {
	 ...
	 echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=subjadd'>Add new term</a></p>";	 
echo "<table border='1' cellpadding='5'>";
...
if ($results['source'] == "mesh") { $source_title = "Medical Subject Headings"; } 
...
<div style="margin-left:550px;"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=authorities&amp;view=subjdelete&id=<? echo $results['id'] ?>">Delete term</a></div>
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
<input type="hidden" name="view" value="subjupdate" />
<input type="hidden" name="id" value="<? echo $results['id'] ?>" />
<table summary="">
<tr><td class="label">Term</td><td><input name="term" size="75" type="text" value="<? echo $results['term'] ?>" /></td></tr>
<tr><td class="label">Use for</td><td><input name="use_for" size="75" type="text" value="<? echo $results['use_for'] ?>" /></td></tr>
<tr><td class="label">Source</td><td>
<select name="source">
<option value="<? echo $results['source'] ?>"><? echo $source_title ?> (current value)</option>
...
<option value="mesh">Medical Subject Headings</option>
<option value="ukat">United Kingdom Archival Thesaurus</option>
<option value="other">other</option>
</select>
</td></tr>
<tr><td class="label">Other Source *</td><td><input name="other" size="75" type="text" value="<? echo $results['other'] ?>" /></td></tr>
<tr><td class="label">External identifier</td><td><input name="ext_id" size="75" type="text" value="<? echo $results['ext_id'] ?>" /></td></tr>
<tr><td class="label">Notes</td><td><textarea cols="61" rows="2" name="notes"><? echo $results['notes'] ?></textarea></td></tr>
<tr><td class="label">Created for</td><td>
<select name="created_for">
<option value="<? echo $results['created_for'] ?>"><? echo $results['created_for'] ?></option>
...
mysql_query($sql_str) or die ("Update subject failed!");
...
echo "<tr><td><strong>Subjects already in database</strong><br /><textarea cols='40' rows='20' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly'>";
while ($results = mysql_fetch_array($subjsearch)):
echo $results['term'] ."\n";
endwhile;
echo "</textarea></td></tr></table>"; ?>
...
mysql_query($sql_str) or die ("Enter subject failed!");
...
echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=csubjadd'>Add another new subject</a>";
...
mysql_query($sql_str) or die ("Delete subject failed!");
...
##	 $sql_str="SELECT * FROM cms_auth_geog WHERE created_for LIKE'$created_for%' AND suppress IS NULL ORDER BY term ASC, island ASC, city ASC, county ASC, country ASC";
	 	 ...
	 	 $sql_str="SELECT CONCAT(term, island, city, county, country, continent) AS geogterm, id, term, island, city, territory, county, country, continent FROM cms_auth_geog WHERE created_for LIKE'$created_for%' AND suppress IS NULL ORDER BY geogterm ASC";

	 $geogsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	 echo "<h3>Place names</h3>";
	 
	  if (isset ($created_for)) {
	 echo "<div>Filtered:".$created_for."</div>";
	 }
	 echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogadd'>Add new term</a></p>";	 
echo "<table border='1' cellpadding='5'>";
while ($results = mysql_fetch_array($geogsearch)):
echo "<tr><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogview&amp;id=".$results['id']."'>".$results['term']." ".$results['island']." ".$results['city']." ".$results['territory']." ".$results['county']." ".$results['country']." ".$results['continent']."</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogedit&amp;id=".$results['id']."'>Edit</a></td></tr>";
endwhile;
echo "</table>";

}
######################################################################################
## display view screen for place name
...
$results = mysql_fetch_array($geogsearch);

if ($results['locator'] <>'') {
	$locators = explode(";", $results['locator']);
	echo "<table align='right' style='margin-right:50px'><tr><td><iframe width='425' height='350' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='http://maps.google.com/?q=".$locators[0].",".$locators[1]."(".$results['term']." ".$results['island']." ".$results['city']." ".$results['territory']." ".$results['county']." ".$results['country']." ".$results['continent'].")&amp;z=12&amp;output=embed&amp;iwloc=0'></iframe></td></tr><tr><td><iframe width='425' height='350' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='http://nls.tileserver.com/?lat=".$locators[0]."&lng=".$locators[1]."&zoom=12'></iframe></td></tr><tr><td><a href='http://www.scotlandsplaces.gov.uk/gazetteer/index.php?search=".$locators[0]."%2C+".$locators[1]."' target='_blank'>Test link to Scotlands Places</a></td></tr></table>";
	
	
	}
##echo $results['part_order'];
...
if ($part == "area") { 
$label = "Term/Area";
$part_contents = $results['term'];
 }
elseif ($part == "territory") { 
$label = "Parish";
 
$part_contents = $results[$part];
 }
else { 
$label = ucwords($part); 
$part_contents = $results[$part];
...
echo "<tr><td class='label'>".$label."</td><td>".$part_contents."</td></tr>";
}
}
...
######################################################################################
## display edit screen for place names
...
<div style="margin-left:550px;"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=authorities&amp;view=geogdelete&id=<? echo $results['id'] ?>">Delete term</a></div>
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
...
echo "<select name='termtype".$count."'><option value='".$part."'>".$label."</option><option></option><option value='area'>Term/Area</option><option value='island'>Island</option><option value='territory'>Parish</option><option value='city'>City</option><option value='county'>County</option><option value='country'>Country</option><option value='continent'>Continent</option></select>";
echo "</td><td><input name='term".$count."' size='75' type='text' value='". $part_contents ."' /></td></tr>";
...
echo "<tr><td class='label'>";
echo "<select name='termtype".$count."'><option></option><option value='area'>Term/Area</option><option value='island'>Island</option><option value='territory'>Parish</option><option value='city'>City</option><option value='county'>County</option><option value='country'>Country</option><option value='continent'>Continent</option></select>";
echo "</td><td><input name='term".$count."' size='75' type='text' /></td></tr>";
...
<tr><td class="label">Alt. form</td><td><input name="alt_form" size="75" type="text" value="<? echo $results['alt_form'] ?>" /></td></tr>
<tr><td class="label">Alt. form language code</td><td><input name="alt_form_lang" size="75" type="text" value="<? echo $results['alt_form_lang'] ?>" /></td></tr>
<tr><td class="label">Use for</td><td><input name="use_for" size="75" type="text" value="<? echo $results['use_for'] ?>" />
<tr><td class="label">Locator</td><td><input name="locator" size="75" type="text" value="<? echo $results['locator'] ?>" /></td></tr></td></tr>
<tr><td class="label">Source</td><td>
<select name="source">
<option value="<? echo $results['source'] ?>"><? echo $source_title ?> (current value)</option>
<option value="lcsh">Library of Congress Subject Headings</option>
...
#########################################################
# Update place name from Edit
elseif ($view == "geogupdate") {

$term1 = mysql_real_escape_string($_GET['term1']);
$term2 = mysql_real_escape_string($_GET['term2']);
$term3 = mysql_real_escape_string($_GET['term3']);
$term4 = mysql_real_escape_string($_GET['term4']);
$term5 = mysql_real_escape_string($_GET['term5']);
$term6 = mysql_real_escape_string($_GET['term6']);
$term7 = mysql_real_escape_string($_GET['term7']);
$termtype1 = mysql_real_escape_string($_GET['termtype1']);
$termtype2 = mysql_real_escape_string($_GET['termtype2']);
$termtype3 = mysql_real_escape_string($_GET['termtype3']);
$termtype4 = mysql_real_escape_string($_GET['termtype4']);
$termtype5 = mysql_real_escape_string($_GET['termtype5']);
$termtype6 = mysql_real_escape_string($_GET['termtype6']);
$termtype7 = mysql_real_escape_string($_GET['termtype7']);
$alt_form = mysql_real_escape_string($_GET['alt_form']);
$alt_form_lang = $_GET['alt_form_lang'];
$use_for = mysql_real_escape_string($_GET['use_for']);
$locator = mysql_real_escape_string($_GET['locator']);
$source = $_GET['source'];
$other = $_GET['other'];
$ext_id = $_GET['ext_id'];
$notes = mysql_real_escape_string($_GET['notes']);
...
$part_order = $termtype1.",".$termtype2.",".$termtype3.",".$termtype4.",".$termtype5.",".$termtype6.",".$termtype7;

$sql_str="UPDATE cms_auth_geog SET id='$id', term='$area', island='$island', city='$city', territory='$territory', county='$county', country='$country', continent='$continent', part_order='$part_order', alt_form='$alt_form', alt_form_lang='$alt_form_lang',  use_for='$use_for', locator='$locator', source='$source', other='$other', ext_id='$ext_id', notes='$notes', last_edited_by='$last_edited_by' WHERE id='$id' LIMIT 1";
...
$geogsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
$results = mysql_fetch_array($geogsearch);
echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogview&amp;id=".$results['id']."'>".$results['term']." ".$results['island']." ".$results['city']." ".$results['territory']." ".$results['county']." ".$results['country']."</a> has been updated</p>";
...
elseif ($view == "geogadd") {
	...
	## $sql_str="SELECT * FROM cms_auth_geog WHERE suppress IS NULL ORDER BY term ASC";
	 $sql_str="SELECT CONCAT(term, island, city, territory, county, country, continent) AS geogterm, id, term, island, city, territory, county, country, continent, part_order FROM cms_auth_geog WHERE created_for LIKE'$created_for%' AND suppress IS NULL ORDER BY geogterm ASC";

	 $geogsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	 
echo "<table align='right' width='200'>";
echo "<tr><td><strong>Place names already in database</strong><br /><textarea cols='40' rows='20' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly'>";
while ($results = mysql_fetch_array($geogsearch)):
...
<h3>Add term: Place name</h3>

<table summary="">
<tr>
<td class="label">
<select name="termtype1">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
<option value="city">City</option>
<option value="county">County</option>
<option value="country">Country</option>
<option value="continent">Continent</option>
</select>
</td><td><input name="term1" size="75" type="text" /></td></tr>
<tr><td class="label">
<select name="termtype2">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
...
<td><input name="term2" size="75" type="text" /></td></tr>
<tr>
<td class="label">
<select name="termtype3">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
...
</td><td><input name="term3" size="75" type="text" /></td></tr>
<tr><td class="label">
<select name="termtype4">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
...
<td><input name="term4" size="75" type="text" /></td></tr>
<tr>
<td class="label">
<select name="termtype5">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
...
</td><td><input name="term5" size="75" type="text" /></td></tr>
<tr><td class="label">
<select name="termtype6">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
...
<td><input name="term6" size="75" type="text" /></td></tr>
<tr><td class="label">
<select name="termtype7">
<option></option>
<option value="area">Area</option>
<option value="island">Island</option>
<option value="territory">Parish</option>
...
<td><input name="term7" size="75" type="text" /></td></tr>
...
<tr><td class="label">Source</td><td class="label">
<select name="source">
<option value="lcsh">Library of Congress Subject Headings</option>
<option value="sss">School of Scottish Studies Thesaurus</option>
<option value="mesh">Medical Subject Headings</option>
...
<tr><td class="label">External identifier</td><td><input name="ext_id" size="75" type="text" /></td></tr>
<tr><td class="label">Notes</td><td><textarea cols="61" rows="2" name="notes"></textarea></td></tr>
<tr><td class="label">Created for</td><td class="label">
<select name="created_for">
<option value=""></option>
<option value="CW">CW</option>
<option value="TD">TD</option>
...
$sql_str="INSERT INTO cms_auth_geog (id, term, island, city, territory, county, country, continent, part_order, alt_form, alt_form_lang, use_for, locator, source, other, ext_id, notes, created_for, created_by, created_on) VALUES  (NULL, '$area', '$island', '$city', '$territory', '$county', '$country', '$continent', '$part_order', '$alt_form', '$alt_form_lang', '$use_for', '$locator', '$source', '$other', '$ext_id', '$notes', '$created_for', '$created_by', '$created_on')";

mysql_query($sql_str) or die ("Enter place failed!");


if ($termtype1 == "area") {$termtype1 = "term"; }
$sql_str="SELECT * FROM cms_auth_geog WHERE $termtype1 LIKE '$term1' AND suppress IS NULL ORDER BY id LIMIT 1";
$subjsearch = mysql_db_query($dbname, $sql_str, $id_link) or ("Search Failed!");
$results = mysql_fetch_array($subjsearch);

echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogview&amp;id=".$results['id']."'>".$results['term']." ".$results['island']." ".$results['city']." ".$results['territory']." ".$results['county']." ".$results['country']." ".$results['continent']."</a> has been added.</p>";

echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogadd'>Add another new place name</a>";
...
mysql_query($sql_str) or die ("Delete place failed!");
...
elseif ($view == "genrlist") {
	 ...
	 $genrsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	 echo "<h3>Genre</h3>";
	 
	  if (isset ($created_for)) {
	 echo "<div>Filtered:".$created_for."</div>";
	 }
	 echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=genradd'>Add new term</a></p>";	 
echo "<table border='1' cellpadding='5'>";
while ($results = mysql_fetch_array($genrsearch)):
...
elseif ($view == "genrview") {
	 ...
	 echo "<h3>Genre</h3>";
echo "<table cellpadding='5'cellspacing='5'>";
$results = mysql_fetch_array($genrsearch);
echo "<tr><td class='label'>ID</td><td>".$results['id']."</td></tr>";
echo "<tr><td class='label'>Term</td><td>".$results['term']."</td></tr>";
echo "<tr><td class='label'>Use for</td><td>".$results['use_for']."</td></tr>";
echo "<tr><td class='label'>Source</td><td>".$results['source']."</td></tr>";
...
<div style="margin-left:550px;"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=authorities&amp;view=genrdelete&id=<? echo $results['id'] ?>">Delete term</a></div>
<form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
<input type="hidden" name="func" value="authorities" />
...
echo "<table align='right' width='200'>";
echo "<tr><td><strong>Genres already in database</strong><br /><textarea cols='40' rows='20' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly'>";
while ($results = mysql_fetch_array($genrsearch)):
echo $results['term'] ."\n";
endwhile;
echo "</textarea></td></tr></table>"; ?>
...
mysql_query($sql_str) or die ("Enter genre failed!");
...
echo "<a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=genradd'>Add another new genre</a>";
...
mysql_query($sql_str) or die ("Delete genre failed!");
