...
<tr><td class="label">Normal</td><td><input name="normal" size="75" type="text" value="<? echo $results['normal'] ?>" /></td></tr>
<tr><td class="label">Family name</td><td><input name="primary_name" size="75" type="text" value="<? echo $results['primary_name'] ?>" /></td></tr>
<tr><td class="label">Given name(s)</td><td><input name="secondary_name" size="75" type="text" value="<? echo $results['secondary_name'] ?>" /></td></tr>
<tr><td class="label">Date(s)</td><td><input name="date" size="75" type="text" value="<? echo $results['date'] ?>" /></td></tr>
<tr><td class="label">Description</td><td><input name="description" size="75" type="text" value="<? echo $results['description'] ?>" /></td></tr>
<tr><td class="label">Variant of</td><td>
