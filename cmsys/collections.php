...
include "/data/d4/archives/cmsys/accstyle.php";
...
echo "<h4>Mapped locations/shelfmarks</h4>";
	 ...
	 $locsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
 
echo "<ul>";
while ($results = mysql_fetch_array($locsearch)):
...
while ($results = mysql_fetch_array($tasksearch)):
