...
echo "<p><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=geogview&amp;id=".$results['id']."'>".$results['term']." ".$results['island']." ".$results['city']." ".$results['county']." ".$results['country']."</a> has been added</p>";
