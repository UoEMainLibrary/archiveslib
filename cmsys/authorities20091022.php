...
<table summary="">
<tr><td class="label">Term</td><td><textarea cols="61" rows="2" name="persterm"><? echo $results['persterm'] ?></textarea></td></tr>
<tr><td class="label">Normal</td><td><input name="normal" size="75" type="text" value="<? echo $results['normal'] ?>" /></td></tr>
...
$persterm = mysql_real_escape_string($_GET['persterm']);
##$term = $_GET['term'];
$normal = mysql_real_escape_string($_GET['normal']);
...
<? $sql_str2="SELECT * FROM cms_auth_pers WHERE suppress IS NULL ORDER BY persterm ASC";
...
elseif ($view == "corplist") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_corp WHERE created_for LIKE'$created_for%' AND suppress IS NULL ORDER BY corpterm ASC";
...
<input type="hidden" name="id" value="<? echo $results['id'] ?>" />
<table summary="">
<tr><td class="label">Term</td><td><textarea cols="61" rows="2" name="corpterm"><? echo $results['corpterm'] ?></textarea></td></tr>
<tr><td class="label">Normal</td><td><input name="normal" size="75" type="text" value="<? echo $results['normal'] ?>" /></td></tr>
...
$corpterm = mysql_real_escape_string($_GET['corpterm']);
##$term = $_GET['term'];
$normal = mysql_real_escape_string($_GET['normal']);
...
<select style="width:409px" name="variant_of">
<option value="0"></option>
<? $sql_str2="SELECT * FROM cms_auth_corp WHERE suppress IS NULL ORDER BY corpterm ASC";
...
mysql_query($sql_str) or die ("<p>Enter corpon failed!</p>");
...
elseif ($view == "geoglist") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_geog WHERE created_for LIKE'$created_for%' AND suppress IS NULL ORDER BY term ASC";
...
<tr><td class="label">Locator</td><td><input name="ext_id" size="75" type="text" value="<? echo $results['locator'] ?>" /></td></tr></td></tr>
<tr><td class="label">Source</td><td>
<select name="source">
<option value="<? echo $results['source'] ?>"><? echo $source_title ?> (current value)</option>
<option value="lcsh">Library of Congress Subject Headings</option>
...
if ($id <> '2024') {
mysql_query($sql_str) or die ("Update failed!");
