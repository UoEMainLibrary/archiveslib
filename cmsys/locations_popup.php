...
$results2 = mysql_fetch_array($boxsearch);   ?>

<form action="<? echo $_SERVER['PHP_SELF'] ?>">
<input type="hidden" name="view" value="updateloc" />
<input type="hidden" name="id" value="<? echo $id ?>" />
<input type="hidden" name="locid" value="<? echo $locid ?>" />
<input type="hidden" name="year" value="<? echo $year ?>" />
<input type="hidden" name="number" value="<? echo $number ?>" />
<input type="hidden" name="popup" value="locations" />
<table>
...
<td>
<select name="type">
<option value="<? echo $results2['type'] ?>">A</option>
<option value="A">A</option>
<option value="D">D</option>
<option value="F">F</option>
<option value="G">G</option>
...
<td><input name="numb" type="text" value="<? echo $results2['numb'] ?>" /></td>
</tr>
<tr><td colspan="2">Other</td><td>
<textarea name="other" cols="30" rows="2"><? echo $results2['other'] ?></textarea>
</td></tr>
<tr><td colspan="2">Notes</td><td>
<textarea name="notes" cols="30" rows="2"><? echo $results2['notes'] ?></textarea>
</td></tr>
</table>
<input name="" type="submit" value="Enter">
</form>
