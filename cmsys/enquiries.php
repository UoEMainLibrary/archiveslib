...
while ($results = mysql_fetch_array($enqsearch)) {
...
<a href="javascript:popUp('popups/popup.php?popup=enquiries&id=<? echo $results['id']?>')">

<? echo "SC-ENQ-".$results['id']."</a></td><td>".$results['enquirer_name']."</td><td>".$results['subject']."</td><td>".$results['received']."</td><td>".$results['acknowledged']."</td><td>".$completed."</td><td>".$due_date." ".$alert."</td><td>".$results['logged_by']."</td><td>".$results['assigned']."</td></tr>";
