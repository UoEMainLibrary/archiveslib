...
<option value ="(general)">(general)</option>
	...
	$unitidsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	while ($results = mysql_fetch_array($unitidsearch)):
...
$nonboxsearch = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
while ($results = mysql_fetch_array($nonboxsearch)):
...
$shelfsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
while ($results = mysql_fetch_array($shelfsearch)):
