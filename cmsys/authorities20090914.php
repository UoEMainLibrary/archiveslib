...
# echo "<tr><td class='label'>Personal names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=perslist'>List, A-Z</a></td></tr>";
...
echo "<table border='1' cellpadding='5'>";
while ($results = mysql_fetch_array($subjsearch)):
echo "<tr><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=".$_GET['type']."view&amp;id=".$results['id']."'>".$results['term']."</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=".$_GET['type']."edit&amp;id=".$results['id']."'>Edit</a></td></tr>";
endwhile;
echo "</table>";
}
...
echo "<tr><td class='label'>Last edited</td><td>".$displaydate."</td></tr>";
echo "<tr><td class='label'>Last edited by</td><td>".$results['last_edited_by']."</td></tr>";
echo "<tr><td class='label'>xml string</td><td><textarea cols='70' rows='2'>&lt;genreform authfilenumber='".$id."' normal='".$results['term']."' source='".$results['source']."'&gt;".$results['term']."&lt;/genreform&gt;</textarea></td></tr>";
...
$type = $_GET['type'];
$term = htmlentities(($_GET['term']), ENT_QUOTES);
$alt_form = htmlentities(($_GET['alt_form']), ENT_QUOTES);
$alt_form_lang = htmlentities(($_GET['alt_form_lang']), ENT_QUOTES);
$use_for = htmlentities(($_GET['use_for']), ENT_QUOTES);
...
echo "xml string: <textarea cols='70' rows='2'>&lt;genreform authfilenumber='".$id."' normal='".$results['term']."' source='".$results['source']."'&gt;".$results['term']."&lt;/genreform&gt;</textarea>";
...
echo "xml string: <textarea cols='70' rows='2'>&lt;subject authfilenumber='".$results['id']."' source='".$results['source']."'&gt;".$results['term']."&lt;/subject&gt;</textarea>";
...
echo "xml string: <textarea cols='70' rows='2'>&lt;geogname authfilenumber='".$results['id']."' normal='".$results['term']."' source='".$results['source']."'&gt;".$results['term']."&lt;/geogname&gt;</textarea>";
