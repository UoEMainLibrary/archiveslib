...
echo "<tr><td class='label'>People</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=perslist'>List, A-Z</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=persadd'>Add new term</a></td></tr>";
