...
echo "<tr><td><strong>People already in database</strong><br /><textarea cols='40' rows='30' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly' wrap='off'>";
while ($results = mysql_fetch_array($perssearch)):
include "nca_name_form_p.php";
echo $nca_str ."\n";
endwhile;
