...
<option value="fam">Family Names</option>
...
elseif ($_GET['type'] == "corp") { $sql_str="SELECT * FROM $table WHERE primary_term LIKE '%$searchterm%' OR secondary_term LIKE '%$searchterm%' AND suppress IS NULL ORDER BY corpterm ASC"; }
...
echo "<table align='right' width='200'>";
echo "<tr><td><strong>Places already in database</strong><br /><textarea cols='40' rows='20' style='font-size:small; color:#000000; background-color:#ffffff' readonly='readonly'>";
while ($results = mysql_fetch_array($geogsearch)):
