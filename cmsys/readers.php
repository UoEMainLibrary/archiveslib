...
echo "<tr><td>"; ?>
<a href="javascript:popUp('popups/popup.php?popup=readers&id=<? echo $results['id']?>')">CRC-RR-<? echo $results['id']?></a>
<? echo "</td><td>".$results['surname']."</td><td>".$results['forenames']."</td><td>".$next_renewal_a.$next_renewal_b."</td>";
