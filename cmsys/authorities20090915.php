...
echo "<p>Please AVOID using your browser's BACK button while working with this database - this can cause erroneous entries to be created.<p>";
##########################################################################
...
echo "<tr><td class='label'>Personal names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=perslist'>List, A-Z</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=persadd'>Add new term</a></td></tr>";
# echo "<tr><td class='label'>Corporate names</td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=corplist'>List, A-Z</a></td></tr>";
...
<option value="genr">Genre</option>
</select> &nbsp;&nbsp;
...
if ($_GET['type'] == "pers") { $sql_str="SELECT * FROM $table WHERE persterm LIKE '%$searchterm%' ORDER BY persterm ASC"; }
else { $sql_str="SELECT * FROM $table WHERE term LIKE '%$searchterm%' ORDER BY term ASC"; }

	 $subjsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
	 echo "<h3>Results</h3>";
echo "<table border='1' cellpadding='5'>";
while ($results = mysql_fetch_array($subjsearch)):
echo "<tr><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=".$_GET['type']."view&amp;id=".$results['id']."'>".$results['term'].$results['persterm']."</a></td><td><a href='".$_SERVER['PHP_SELF']."?func=authorities&amp;view=".$_GET['type']."edit&amp;id=".$results['id']."'>Edit</a></td></tr>";
endwhile;
echo "</table>";
}
...
elseif ($view == "perslist") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_pers ORDER BY persterm ASC";
...
$sql_str1="SELECT id FROM cms_auth_pers WHERE id < $id ORDER BY ID DESC LIMIT 1";
$navsearch1 = mysql_db_query($dbname, $sql_str1, $id_link) or die("Search Failed!");
$results1 = mysql_fetch_array($navsearch1);
$prev = $results1['id'];

$sql_str2="SELECT id FROM cms_auth_pers WHERE id > $id ORDER BY ID ASC LIMIT 1";
...
<?   $var_id = $results['variant_of'];
	if ($var_id == 0 ) {
     ...
     $sql_str2="SELECT * FROM cms_auth_pers where id='$var_id'";
...
<? $sql_str2="SELECT * FROM cms_auth_pers ORDER BY persterm ASC";
...
$sql_str="SELECT * FROM cms_auth_pers WHERE persterm LIKE '$persterm'";
...
echo "<p>placeholder: view interface here: corpview</p>";
}
...
elseif ($view == "subjlist") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_subj ORDER BY term ASC";
...
$sql_str1="SELECT id FROM cms_auth_subj WHERE id < $id ORDER BY ID DESC LIMIT 1";
$navsearch1 = mysql_db_query($dbname, $sql_str1, $id_link) or die("Search Failed!");
$results1 = mysql_fetch_array($navsearch1);
$prev = $results1['id'];

$sql_str2="SELECT id FROM cms_auth_subj WHERE id > $id ORDER BY ID ASC LIMIT 1";
$navsearch2 = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
$results2 = mysql_fetch_array($navsearch2);
$next = $results2['id'];
...
$sql_str="SELECT * FROM cms_auth_subj WHERE term LIKE '$term'";
$subjsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
$results = mysql_fetch_array($subjsearch);
...
elseif ($view == "geoglist") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_geog ORDER BY term ASC";
...
$sql_str1="SELECT id FROM cms_auth_geog WHERE id < $id ORDER BY ID DESC LIMIT 1";
$navsearch1 = mysql_db_query($dbname, $sql_str1, $id_link) or die("Search Failed!");
$results1 = mysql_fetch_array($navsearch1);
$prev = $results1['id'];

$sql_str2="SELECT id FROM cms_auth_geog WHERE id > $id ORDER BY ID ASC LIMIT 1";
$navsearch2 = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
$results2 = mysql_fetch_array($navsearch2);
$next = $results2['id'];
...
$sql_str="SELECT * FROM cms_auth_geog WHERE term LIKE '$term'";
$subjsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
$results = mysql_fetch_array($subjsearch);
...
elseif ($view == "genrlist") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_genr ORDER BY term ASC";
...
$sql_str1="SELECT id FROM cms_auth_genr WHERE id < $id ORDER BY ID DESC LIMIT 1";
$navsearch1 = mysql_db_query($dbname, $sql_str1, $id_link) or die("Search Failed!");
$results1 = mysql_fetch_array($navsearch1);
$prev = $results1['id'];

$sql_str2="SELECT id FROM cms_auth_genr WHERE id > $id ORDER BY ID ASC LIMIT 1";
$navsearch2 = mysql_db_query($dbname, $sql_str2, $id_link) or die("Search Failed!");
$results2 = mysql_fetch_array($navsearch2);
$next = $results2['id'];
...
$sql_str="SELECT * FROM cms_auth_genr WHERE term LIKE '$term'";
$subjsearch = mysql_db_query($dbname, $sql_str, $id_link) or die("Search Failed!");
$results = mysql_fetch_array($subjsearch);
...
elseif ($view == "persfix") {
	 ...
	 $sql_str="SELECT * FROM cms_auth_pers ORDER BY id ASC";
