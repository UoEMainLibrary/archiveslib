...
<tr>
<td class="menutable">Search Collection Titles<br /><form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
...
<tr>
<td class="menutable"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=collections&amp;view=numlist">Numerical list</a></td>
</tr>
<tr>
<td class="menutable">
...
<tr>
<td class="menutable">Search Accessions<br /><form action="<? echo $_SERVER['PHP_SELF'] ?>" method="GET">
...
<tr>
<td class="menutable"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=loc_eua">University Archives</a></td>
</tr>
<tr>
<td class="menutable"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=loc_clx">'E' Accessions</a></td>
</tr>
<tr>
<td class="menutable"><a href="<? echo $_SERVER['PHP_SELF'] ?>?func=pi">Phot.Ill.</a></td>
</tr>
</table>
</td>
</tr>
