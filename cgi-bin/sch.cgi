...
$basedir = '/home/archives/public_docs/isaar/';
$baseurl = 'http://www.archives.lib.ed.ac.uk/isaar/';
@files = ('*.html');
$title = "Matt's Script Archive";
$title_url = 'http://www.archives.lib.ed.ac.uk/';
