	  ...
	  SUMMARY="layout"> 
		<TBODY> 
		  <TR> 
			 ...
			 <TD ALIGN="left" HEIGHT="60" VALIGN="top" WIDTH="80%"><IMG
				ALT="Rebuilding the City: the Percy Johnson Marshall Collection" HEIGHT="39"
				SRC="/graphics/titlesmall.jpg"
				WIDTH="393"></TD> 
			 <TD WIDTH="57" HEIGHT="60"></TD> 
		  </TR> 
			
		  <TR> 
			 <TD ALIGN="right" VALIGN="top" WIDTH="20%" HEIGHT="149"> 
				<P><A HREF="/index.html"><FONT SIZE="2">Home</FONT></A></P> 
				 
				<P><FONT COLOR="#CC6600" SIZE="2"><A HREF="index.html">Search /
				  Browse the Collection</A></FONT></P> 
				</TD> 
			 <TD ALIGN="left" HEIGHT="149" VALIGN="TOP" width="80%" COLSPAN="2">
			 <hr color="#cc6600" size="3" />
